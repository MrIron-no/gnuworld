...
protected:
   ...
   */
  typedef std::map<std::string, pthread_mutex_t, noCaseCompare> mutexMapType;
...
public:
   ...
   */
  virtual bool isRunning() const { return (keepRunning && (threadID != 0)); }
   ...
   */
  virtual void Stop() { keepRunning = false; }
