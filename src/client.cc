...
void xClient::OnOper(iClient*) {}

void xClient::OnNetBreak(iServer*, const iServer*, std::string_view) {}

void xClient::OnNetJoin(iServer*, const iServer*) {}

void xClient::OnBurstComplete(iServer*) {}

void xClient::OnBurstAck(iServer*) {}

void xClient::OnEndOfBurstAckSent(iServer*) {}

void xClient::OnGline(Gline*) {}

void xClient::OnRemGline(Gline*) {}

void xClient::OnQuit(iClient*, std::string_view) {}

void xClient::OnKill(const NetworkTarget*, iClient*, std::string_view) {}

void xClient::OnNick(iClient*) {}

void xClient::OnNickChange(iClient*, std::string_view) {}

void xClient::OnAccount(iClient*) {}

void xClient::OnAccountFlags(iClient*) {}

void xClient::OnRaw(std::string_view) {}

void xClient::OnXQuery(iServer*, std::string_view, std::string_view) {}

void xClient::OnXReply(iServer*, std::string_view, std::string_view) {}

void xClient::OnNetConf(iServer*, std::string_view) {}
...
void xClient::OnTopic(Channel*, iClient*, std::string_view) {}

void xClient::OnServerMode(Channel*, iServer*) {}
