...
public:
   ...
   * channels).
   */
  virtual void OnFakeChannelMessage(iClient*, iClient*, Channel*, const std::string&);
...
protected:
   ...
   */
  void handleSpawnClient(iClient*, Channel*, const StringTokenizer&);

  /**
   * Have a spawned client join a channel.
   * This should be replaced soon.
   */
  void handleSpawnJoin(iClient*, Channel*, const StringTokenizer&);

  /**
   * Have a spawned client part a channel.
   * This should be replaced soon.
   */
  void handleSpawnPart(iClient*, Channel*, const StringTokenizer&);

  /**
   * Have a spawned client quit.
   * This should be replaced soon.
   */
  void handleSpawnQuit(iClient*, const StringTokenizer&);
