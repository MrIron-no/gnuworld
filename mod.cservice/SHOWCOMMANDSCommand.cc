...
static const char* lvl_0_cmds = "\002Level    0\002: access chaninfo fingerprint info help* lbanlist login motd* newpass showcommands showignore verify suspendme";
