...
public:
  Command(cservice* _bot, const string& _commName, const string& _help,
          unsigned short _flood_points)
      : bot(_bot), server(0), commName(_commName), help(_help), flood_points(_flood_points) {}
  virtual ~Command() {}
  ...
  inline const unsigned short& getFloodPoints() const { return flood_points; }
...
#define DECLARE_COMMAND(commName)                                                                  \
  ...
  public:                                                                                          \
    commName##Command(cservice* _bot, const string& _commName, const string& _help,                \
                      unsigned short _flood_points)                                                \
