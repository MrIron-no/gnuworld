...
enum CLIENT_STATE { UNKNOWN, NORMAL, ABNORMAL };
...
public:
   ...
   */
  inline CLIENT_STATE getState() const { return currentState; }
   ...
   */
  inline CLIENT_STATE setState(CLIENT_STATE _currentState) { return currentState = _currentState; }

  /**
   * Accessor for the entropy value.
   * @return	the current entropy value
   */
  inline double getEntropy() const { return entropy; }
