...
class dronescan : public xClient {
  public:
    ...
    bool isSpamExcluded(const SpamActor& actor, const std::string& channel_name, bool isOper) const;
     ...
     */
    void scheduleSpyClientJoin(const std::string& chanName, bool forcejoin, int minDelay,
                               int maxDelay);
