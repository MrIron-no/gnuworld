...
class Test {
public:
  Test(dronescan* _bot, const std::string& _testName, const std::string& _description,
  ...
  virtual inline bool setVariable(const std::string&, const std::string&) { return false; }

  virtual inline const std::string& getName() const { return testName; }
  virtual inline const std::string& getDescription() const { return description; }
  virtual inline unsigned short getWeight() const { return weight; }

  virtual const std::string getVariable() const { return std::string(); }

  virtual inline const std::string getStatus() const { return std::string(); }
...
#define DECLARE_TEST(testName)                                                                     \
  ...
  public:                                                                                          \
    testName##Test(dronescan* _bot, const std::string& _testName, const std::string& _description, \
                   const unsigned short _weight)                                                   \
        : Test(_bot, _testName, _description, _weight){};                                          \
    virtual ~testName##Test(){};                                                                   \
    virtual bool isNormal(const Channel*);

#define DECLARE_TEST_FULL(testName)                                                                \
  DECLARE_TEST(testName)                                                                           \
  }                                                                                                \
  ;

#define DECLARE_TEST_SET(testName)                                                                 \
  DECLARE_TEST(testName)                                                                           \
