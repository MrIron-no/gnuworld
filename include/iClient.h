...
public:
   ...
   */
  iClient(const unsigned int& _uplink, const std::string& _yyxxx, const std::string& _nickName,
          const std::string& _userName, const std::string& _hostBase64,
          const std::string& _insecureHost, const std::string& _realInsecureHost,
          const std::string& _mode, const std::string& _account, const unsigned int _account_id,
          const flagType _account_flags, const std::string& _tls_fingerprint,
          const std::string& _description, const time_t& _nick_ts);
   ...
   */
  inline const std::string& getInsecureHost() const { return insecureHost; }

  /**
   * Retrieve the iClient's 'real' host name.
   */
  inline const std::string& getRealInsecureHost() const { return realInsecureHost; }

  /**
   * Retrieve a string of the form: nick!user for this user.
   */
  inline const std::string getNickUser() const { return (nickName + '!' + userName); }
   ...
   */
  inline const std::string getRealUserHost() const { return (userName + '@' + realInsecureHost); }
   ...
   */
  inline const std::string& getTlsFingerprint() const { return tlsFingerprint; }

  /**
   * Returns true if the client has a fingerprint.
   */
  inline bool hasTlsFingerprint() const { return !tlsFingerprint.empty(); }
   ...
   */
  inline void setHiddenHost() { insecureHost = account + hiddenHostSuffix; }

  /**
   * This method will set the hidden host suffix.  This value
   * is only modified by the xServer on startup.
   */
  inline static void setHiddenHostSuffix(const std::string& newVal) { hiddenHostSuffix = newVal; }
   ...
   */
  inline const unsigned int& getAccountID() const { return account_id; }
   ...
   */
  inline const flagType& getAccountFlags() const { return account_flags; }
   ...
   */
  inline static const std::string& getHiddenHostSuffix() { return hiddenHostSuffix; }
   ...
   */
  inline const std::string& getSetHost() const { return setHost; }
#endif
   ...
   */
  inline const std::string& getFakeHost() const { return fakeHost; }
#endif
   ...
   */
  inline const time_t& getNickTS() const { return nick_ts; }
   ...
   */
  inline const time_t& getFirstNickTS() const { return first_nick_ts; }

  /**
   * Set the iClient's nickname timestamp.
   */
  inline void setNickTS(const time_t& newTS) { nick_ts = newTS; }

  /**
   * Retrieve the iClient's IP. Network byte ordered
   */
  inline const irc_in_addr& getIP() const { return IP; }

  /*
   * Cut down all the numeric conversions, get it directly
   */
  inline const std::string& getNumericIP() const { return numericIP; }

  /**
   * Return the iClient's channelList.
   */
  inline const channelListType channels() const { return channelList; }

  /**
   * Obtain const iterator to beginning of this user's channel
   * membership structure.
   */
  inline const_channelIterator channels_begin() const { return channelList.begin(); }

  /**
   * Obtain const iterator to end of this user's channel
   * membership structure.
   */
  inline const_channelIterator channels_end() const { return channelList.end(); }

  /**
   * Obtain mutable iterator to beginning of this user's channel
   * membership structure.
   */
  inline channelIterator channels_begin() { return channelList.begin(); }

  /**
   * Obtain mutable iterator to end of this user's channel
   * membership structure.
   */
  inline channelIterator channels_end() { return channelList.end(); }

  /**
   * Return the number of channels which this user is on.
   */
  inline channels_sizeType channels_size() const { return channelList.size(); }
   ...
   */
  inline void clearChannels() { channelList.clear(); }
   ...
   */
  inline void setNickName(const std::string& newNick) { nickName = newNick; }
   ...
   * otherwise.
   */
  inline bool getMode(const modeType& theMode) const { return (theMode == (mode & theMode)); }

  /**
   * Return true if this client has the +i mode set, false otherwise.
   */
  inline bool isModeI() const { return getMode(MODE_INVISIBLE); }

  /**
   * Return true if this client has the +w mode set, false otherwise.
   */
  inline bool isModeW() const { return getMode(MODE_WALLOPS); }

  /**
   * Return true if this client has the +k mode set, false otherwise.
   */
  inline bool isModeK() const { return getMode(MODE_SERVICES); }

  /**
   * Return true if this client has the +o mode set, false otherwise.
   */
  inline bool isModeO() const { return getMode(MODE_OPER); }

  /**
   * Return true if this client has the +d mode set, false otherwise.
   */
  inline bool isModeD() const { return getMode(MODE_DEAF); }

  /**
   * Return true if this client has the +r mode set, false otherwise.
   */
  inline bool isModeR() const { return getMode(MODE_REGISTERED); }

  /**
   * Return true if this client has the +x mode set, false otherwise.
   */
  inline bool isModeX() const { return getMode(MODE_HIDDEN_HOST); }

  /**
   * Return true if this client has the +g mode set, false otherwise.
   */
  inline bool isModeG() const { return getMode(MODE_G); }

  /**
   * Return true if this client has the +z mode set,
   * indicating that the client is using TLS. False otherwise.
   */
  inline bool isModeZ() const { return getMode(MODE_TLS); }

  /**
   * Return true if this iClient is a fake, false otherwise.
   */
  inline bool isFake() const { return getMode(MODE_FAKE); }

  /**
   * Return true if this iClient is an oper, false otherwise.
   */
  inline bool isOper() const { return getMode(MODE_OPER); }

  /**
   * Return this iClient's current user modes.
   */
  inline const modeType& getModes() const { return mode; }

  /**
   * Set a user mode for this iClient.
   */
  inline void setMode(const modeType& newMode) { mode |= newMode; }

  /**
   * Set mode +i for this user.
   */
  inline void setModeI() { setMode(MODE_INVISIBLE); }

  /**
   * Set mode +w for this user.
   */
  inline void setModeW() { setMode(MODE_WALLOPS); }

  /**
   * Set mode +k for this user.
   */
  inline void setModeK() { setMode(MODE_SERVICES); }

  /**
   * Set mode +d for this user.
   */
  inline void setModeD() { setMode(MODE_DEAF); }

  /**
   * Set mode +g for this user.
   */
  inline void setModeG() { setMode(MODE_G); }

  /**
   * Set mode +o for this user.
   */
  inline void setModeO() { setMode(MODE_OPER); }
   ...
   */
  inline void setModeR() { setMode(MODE_REGISTERED); }

  /**
   * Set mode +z for this user.
   */
  inline void setModeZ() { setMode(MODE_TLS); }

  /**
   * Designate this iClient as a fake.
   */
  inline void setFake() { setMode(MODE_FAKE); }

  /**
   * Remove a user mode for this iClient.
   */
  inline void removeMode(const modeType& theMode) { mode &= ~theMode; }

  /**
   * Remove user mode 'i'.
   */
  inline void removeModeI() { removeMode(MODE_INVISIBLE); }

  /**
   * Remove user mode 'w'.
   */
  inline void removeModeW() { removeMode(MODE_WALLOPS); }

  /**
   * Remove user mode 'k'.
   */
  inline void removeModeK() { removeMode(MODE_SERVICES); }

  /**
   * Remove user mode 'd'.
   */
  inline void removeModeD() { removeMode(MODE_DEAF); }

  /**
   * Remove user mode 'g'.
   */
  inline void removeModeG() { removeMode(MODE_G); }

  /**
   * Remove user mode 'o'.
   */
  inline void removeModeO() { removeMode(MODE_OPER); }

  /**
   * Remove user mode 'x'.
   */
  inline void removeModeX() { removeMode(MODE_HIDDEN_HOST); }

  /**
   * Remove user mode 'r'.
   */
  inline void removeModeR() { removeMode(MODE_REGISTERED); }
   ...
   */
  friend ELog& operator<<(ELog& out, const iClient& theClient) {
    out << theClient.nickName << '!' << theClient.userName << '@' << theClient.insecureHost
