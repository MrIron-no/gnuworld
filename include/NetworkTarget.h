...
public:
   ...
   */
  NetworkTarget() : intYY(0), intXXX(0) {
   ...
   * numerics.
   */
  NetworkTarget(const unsigned int& intYY, const unsigned int& intXXX) {
    setIntYY(intYY);
    setIntXXX(intXXX);
  }
   ...
   * target's server.
   */
  inline unsigned int getIntYY() const { return intYY; }

  /**
   * Return the integer base 64 representation of this
   * target's client identifier (relative to its server).
   */
  inline unsigned int getIntXXX() const { return intXXX; }

  /**
   * Return the integer base 64 representation of this
   * target's full client/server numeric.
   */
  inline unsigned int getIntYYXXX() const { return combinebase64int(intYY, intXXX); }

  /**
   * Return the char array base 64 representation of this
   * target's server.
   */
  inline const std::string getCharYY() const { return std::string(charYY); }

  /**
   * Return the char array base 64 representation of this
   * target's client identifier (relative to its server).
   */
  inline const std::string getCharXXX() const { return std::string(charXXX); }

  /**
   * Return the char array base 64 representation of this
   * target's full client/server numeric.
   */
  inline const std::string getCharYYXXX() const { return (getCharYY() + getCharXXX()); }
