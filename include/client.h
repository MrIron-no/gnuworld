...
public:
   ...
   */
  virtual bool Mode(const std::string& chanName, const std::string& modes, const std::string& args,
   ...
   */
  virtual bool DoFakeCTCP(const iClient* Target, const iClient* srcClient, const std::string& CTCP,
                          const std::string& Message);
   ...
   */
  inline bool getMode(const modeType& whichMode) const { return ((mode & whichMode) == whichMode); }
