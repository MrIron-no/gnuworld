...
extern "C" {
xClient* _gnuwinit(const std::string& args) { return new chanfix(args); }
}
 ...
 */
chanfix::chanfix(const std::string& configFileName) : xClient(configFileName) {
  ...
  RegisterCommand(new ADDFLAGCommand(this, "ADDFLAG", "<username> <flag>", 3,
                                     sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
  RegisterCommand(new ADDHOSTCommand(this, "ADDHOST", "<username> <nick!user@host>", 3,
                                     sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
  RegisterCommand(new ADDNOTECommand(this, "ADDNOTE", "<#channel> <reason>", 3,
                                     0 /* Set to 0 to allow all opers to access it, otherwise this
                                          should be sqlcfUser::F_COMMENT */
                                     ));
  RegisterCommand(new ADDUSERCommand(this, "ADDUSER", "<username> [host]", 2,
                                     sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
  RegisterCommand(new ALERTCommand(this, "ALERT", "<#channel> <reason>", 3,
                                   0 /* Set to 0 to allow all opers to access it, otherwise this
                                        should be sqlcfUser::F_COMMENT */
                                   ));
  RegisterCommand(new BLOCKCommand(this, "BLOCK", "<#channel> <reason>", 3, sqlcfUser::F_BLOCK));
  RegisterCommand(new CANFIXCommand(this, "CANFIX", "<#channel>", 2, 0));
  RegisterCommand(new CHANFIXCommand(this, "CHANFIX", "<#channel> [override]", 2,
                                     0 /* Set to 0 to allow all opers to access it, otherwise this
                                          should be sqlcfUser::F_CHANFIX */
                                     ));
  RegisterCommand(new CHECKCommand(this, "CHECK", "<#channel>", 2, 0));
#ifdef CHANFIX_DEBUG
  ...
  RegisterCommand(new DELHOSTCommand(this, "DELHOST", "<username> <nick!user@host>", 3,
                                     sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
  RegisterCommand(new DELNOTECommand(this, "DELNOTE", "<#channel> <note_id>", 3,
                                     0 /* Set to 0 to allow all opers to access it, otherwise this
                                          should be sqlcfUser::F_COMMENT */
                                     ));
  ...
  RegisterCommand(new HISTORYCommand(this, "HISTORY", "<#channel>", 2, 0));
  RegisterCommand(new INFOCommand(this, "INFO", "<#channel>", 2, 0));
  RegisterCommand(new INVITECommand(this, "INVITE", "", 1, sqlcfUser::F_OWNER));
  RegisterCommand(new LASTCOMCommand(this, "LASTCOM", "[amount of commands] [days from]", 1,
                                     sqlcfUser::F_OWNER));
  RegisterCommand(new LISTBLOCKEDCommand(this, "LISTBLOCKED", "", 1, sqlcfUser::F_BLOCK));
  RegisterCommand(new LISTHOSTSCommand(this, "LISTHOSTS", "[username]", 1, sqlcfUser::F_LOGGEDIN));
  RegisterCommand(new OPLISTCommand(this, "OPLIST", "<#channel> [-all] [-nodays]", 2, 0));
  RegisterCommand(new OPNICKSCommand(this, "OPNICKS", "<#channel>", 2, 0));
#ifdef ENABLE_QUOTE
  RegisterCommand(new QUOTECommand(this, "QUOTE", "<text>", 2, sqlcfUser::F_OWNER));
#endif /* ENABLE_QUOTE */
  RegisterCommand(new REHASHCommand(this, "REHASH", "", 1, sqlcfUser::F_OWNER));
  RegisterCommand(new RELOADCommand(this, "RELOAD", "[reason]", 1, sqlcfUser::F_OWNER));
  RegisterCommand(new REQUESTOPCommand(this, "REQUESTOP", "<#channel>", 2, 0));
  RegisterCommand(new SCORECommand(this, "SCORE", "<#channel> [account|=nick]", 2, 0));
  RegisterCommand(new SCORECommand(this, "CSCORE", "<#channel> [account|=nick]", 2, 0));
  RegisterCommand(new SAYCommand(this, "SAY", "<#channel> <text>", 3, sqlcfUser::F_OWNER));
  RegisterCommand(new SETCommand(this, "SET", "<option> <value>", 3, sqlcfUser::F_OWNER));
#ifdef USERADMIN
  RegisterCommand(
      new SETGROUPCommand(this, "SETGROUP", "<username> <group>", 3, sqlcfUser::F_USERMANAGER));
#endif
  RegisterCommand(new SIMULATECommand(this, "SIMULATE", "<#channel> <auto/manual>", 3,
                                      0 /* Set to 0 to allow all opers to access it, otherwise this
                                           should be sqlcfUser::F_CHANFIX */
                                      ));
  RegisterCommand(new SHUTDOWNCommand(this, "SHUTDOWN", "[reason]", 1, sqlcfUser::F_OWNER));
  RegisterCommand(new STATUSCommand(this, "STATUS", "", 1, 0));
#ifdef USERADMIN
  RegisterCommand(new SUSPENDCommand(this, "SUSPEND", "<username>", 2,
                                     sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
#endif
  RegisterCommand(new UNALERTCommand(this, "UNALERT", "<#channel>", 2,
                                     0 /* Set to 0 to allow all opers to access it, otherwise this
                                          should be sqlcfUser::F_COMMENT */
                                     ));
  RegisterCommand(new UNBLOCKCommand(this, "UNBLOCK", "<#channel>", 2, sqlcfUser::F_BLOCK));
#ifdef USERADMIN
  RegisterCommand(new UNSUSPENDCommand(this, "UNSUSPEND", "<username>", 2,
                                       sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
#endif
  RegisterCommand(new USERSCORESCommand(this, "USERSCORES", "<account>", 2, sqlcfUser::F_LOGGEDIN));
  RegisterCommand(
      new USETCommand(this, "USET", "[username] <option> <value>", 3, sqlcfUser::F_LOGGEDIN));
  RegisterCommand(new WHOFLAGCommand(this, "WHOFLAG", "<flag>", 2, sqlcfUser::F_LOGGEDIN));
#ifdef USERADMIN
  RegisterCommand(new WHOGROUPCommand(this, "WHOGROUP", "[group]", 1,
                                      sqlcfUser::F_USERMANAGER | sqlcfUser::F_SERVERADMIN));
#endif
  RegisterCommand(
      new WHOISCommand(this, "WHOIS", "<username|=nick|*> [-modif]", 2, sqlcfUser::F_LOGGEDIN));
...
void chanfix::readConfigFile(const std::string& configFileName) {
  ...
  elog << "chanfix::readConfigFile> Configuration loaded!" << std::endl;
}
...
/* OnShutdown */
void chanfix::OnShutdown(const std::string& reason) { MyUplink->UnloadClient(this, reason); }
...
/* OnDisconnect */
void chanfix::OnDisconnect() { xClient::OnDisconnect(); }

void chanfix::OnPrivateMessage(iClient* theClient, const std::string& Message, bool) {
  sqlcfUser* theUser = isAuthed(theClient->getAccount());

  if (currentState == BURST) {
    if (theUser)
      SendTo(theClient, getResponse(theUser, language::no_commands_during_burst,
                                    std::string("Sorry, I do not accept commands during a burst."))
                            .c_str());
    else
      SendTo(theClient,
             getResponse(theUser, language::no_commands_during_burst_noper,
                         std::string("Sorry, I'm too busy at the moment. Please try again soon."))
                 .c_str());
    return;
  }
  ...
  if (commHandler == commandMap.end()) {
    SendTo(
        theClient,
        getResponse(theUser, language::unknown_command, std::string("Unknown command.")).c_str());
    return;
  }
  ...
  /* Hidden: As of 2024-05-04, require opers to be authenticated to use oper level commands.
     This is mainly for logging purposes, otherwise chanfix and oper notes are empty, as only
     account is stored in the note, not the nick!user@host.
  */
  if (theClient->getAccount().length() == 0) {
    if (Command != "CANFIX" && Command != "HELP" && Command != "REQUESTOP") {
      SendTo(theClient, getResponse(theUser, language::need_to_auth,
                                    std::string("You need to authenticate to use this command."))
                            .c_str());
      return;
    }
  }
  ...
  if (requiredFlags) {
    ...
    if (theUser->getIsSuspended()) {
      SendTo(theClient, getResponse(theUser, language::access_suspended,
                                    std::string("Your access to this service is suspended."))
                            .c_str());
      return;
    }
    ...
    if (!theUser->matchHost(theClient->getRealNickUserHost().c_str())) {
      SendTo(theClient,
             getResponse(
                 theUser, language::host_not_matching,
                 std::string(
                     "Your current host does not match any registered hosts for your username."))
                 .c_str());
      return;
    }
#endif

    if (requiredFlags != sqlcfUser::F_LOGGEDIN && !theUser->getFlag(requiredFlags)) {
      if (getFlagChar(requiredFlags) != ' ')
        SendTo(theClient,
               getResponse(theUser, language::requires_flag,
                           std::string("This command requires flag '%c'."))
                   .c_str(),
               getFlagChar(requiredFlags));
      else
        SendTo(theClient,
               getResponse(theUser, language::requires_flags,
                           std::string("This command requires one of these flags: \"%s\"."))
                   .c_str(),
...
void chanfix::OnCTCP(iClient* theClient, const std::string& CTCP, const std::string& Message,
                     bool Secure) {
  ...
  if (Command == "DCC") {
    ...
    DoCTCP(theClient, CTCP,
           "Evilnet Development -- mod.openchanfix v2.1 [compiled " __DATE__ " " __TIME__ "]");
...
bool chanfix::logLastComMessage(iClient* theClient, const std::string& Message) {
  ...
  const std::string username =
      (theClient->getAccount() != "") ? theClient->getAccount() : theClient->getNickName();

  std::string log;
  dbHandle* cacheCon = getLocalDBHandle();

  static const char* Main = "INSERT into comlog (ts,user_name,command) VALUES (date_part('epoch', "
                            "CURRENT_TIMESTAMP)::int,'";

  std::stringstream insertString;
  insertString << Main << username << "','" << Command << " ";
  ...
  insertString << "')" << std::ends;

  if (!cacheCon->Exec(insertString.str())) {
    elog << "sqlChannel::Insert> Something went wrong: " << cacheCon->ErrorMessage() << std::endl;
  }
...
bool chanfix::msgTopOps(Channel* netChan) {
  ...
  for (chanOpsType::iterator opPtr = myOps.begin(); opPtr != myOps.end() && (opCount < OPCOUNT);
       opPtr++) {
    ...
    if (!inChan) {
      ...
      for (accountListType::iterator cptr = accountList.begin(); (cptr != accountList.end());
           cptr++) {
        curAccount = *cptr;

        MyUplink->Write("%s P %s :%s channel modes have been removed to allow you to return. "
                        "Please return so that I can op you during the channel fixing process\r\n",
                        getCharYYXXX().c_str(), curAccount->getCharYYXXX().c_str(),
                        netChan->getName().c_str());

        MyUplink->Write("%s P %s :\002DO NOT REPLY TO THIS MESSAGE\002\r\n", getCharYYXXX().c_str(),
                        curAccount->getCharYYXXX().c_str());
      }
    }
  }
...
void chanfix::SendFmtTo(iClient* theClient, const std::string& theMessage) {
  ...
  *b = '\0'; // What's this for? 'b' isn't used anymore.
  ...
  if (theUser) {
    if (!theUser->getUseNotice())
      MyUplink->Write("%s P %s :%s\r\n", getCharYYXXX().c_str(), theClient->getCharYYXXX().c_str(),
                      buffer);
    else
      MyUplink->Write("%s O %s :%s\r\n", getCharYYXXX().c_str(), theClient->getCharYYXXX().c_str(),
                      buffer);
...
void chanfix::precacheChanOps() {
  ...
  theQuery << "SELECT "
              ...
              "day5,day6,day7,day8,day9,day10,day11,day12,day13 FROM chanOps ORDER BY channel ASC, "
              "ts_firstopped ASC";
...
void chanfix::precacheChannels() {
  ...
  elog << "*** [chanfix::precacheChannels]: Loading channels ..." << std::endl;
  ...
  if (cacheCon->Exec(theQuery.str(), true)) {
    ...
    elog << "*** [chanfix::precacheChannels] Error executing query: " << cacheCon->ErrorMessage()
         << std::endl;
    ::exit(0);
  }

  elog << "*** [chanfix::precacheChannels]: Done. Loaded " << sqlChanCache.size() << " channels."
       << std::endl;
...
void chanfix::precacheUsers() {
  ...
  myQuery << "SELECT id, user_name, created, last_seen, last_updated, last_updated_by, "
             "language_id, faction, flags, issuspended, usenotice, needoper "
          << "FROM users";

  if (cacheCon->Exec(myQuery.str(), true)) {

    /* First we need to clear the current cache. */
    for (usersMapType::iterator itr = usersMap.begin(); itr != usersMap.end(); ++itr) {
      delete itr->second;
    }
    usersMap.clear();
    ...
    elog << "*** [chanfix::precacheUsers] Error executing query: " << cacheCon->ErrorMessage()
         << std::endl;
    ::exit(0);
  }
  ...
  elog << "chanfix::precacheUsers> Loaded " << usersMap.size() << " users." << std::endl;
...
void chanfix::changeState(STATE newState) {
  ...
  switch (currentState) {
  case BURST: {
    elog << "chanfix::changeState> Exiting state BURST" << std::endl;
    break;
  }
  case RUN: {
    elog << "chanfix::changeState> Exiting state RUN" << std::endl;
    break;
  }
  case SPLIT: {
    elog << "chanfix::changeState> Exiting state SPLIT" << std::endl;
    break;
  }
  case INIT: {
    elog << "chanfix::changeState> Exiting state INIT" << std::endl;
    break;
  }
  }
  ...
  switch (currentState) {
  case BURST: {
    elog << "chanfix::changeState> Entering state BURST" << std::endl;
    break;
  }
  case RUN: {
    elog << "chanfix::changeState> Entering state RUN" << std::endl;
    break;
  }
  case SPLIT: {
    elog << "chanfix::changeState> Entering state SPLIT" << std::endl;
    break;
  }
  case INIT: {
    elog << "chanfix::changeState> Entering state INIT" << std::endl;
    break;
  }
  }

  elog << "Changed state in: " << stateTimer.stopTimeMS() << "ms" << std::endl;
}
...
sqlChanOp* chanfix::findChanOp(const std::string& channel, const std::string& account) {
  ...
  if (ptr != sqlChanOps.end()) {
    ...
    if (chanOp != ptr->second.end())
       ...
       *	<< chanOp->second->getAccount() << " on " << chanOp->second->getChannel() << "!!" <<
       *std::endl;
       */
...
size_t chanfix::countMyOps(Channel* theChan) { return countMyOps(theChan->getName()); }
...
const std::string chanfix::getHostList(sqlcfUser* User) {
  ...
  std::stringstream theQuery;
  theQuery << queryHeader << User->getID();

  if (!cacheCon->Exec(theQuery.str(), true)) {
    elog << "chanfix::getHostList> SQL Error: " << cacheCon->ErrorMessage() << std::endl;
    return 0;
  }
...
void chanfix::checkNetwork() {
  if (100 * Network->serverList_size() < numServers * minServersPresent) {
    if (currentState != SPLIT) {
      elog << "chanfix::checkNetwork> DEBUG: Not enough servers linked! Going to SPLIT-state"
           << std::endl;
      changeState(SPLIT);
    }
    return;
  ...
  if (currentState == SPLIT) {
    elog << "chanfix::checkNetwork> DEBUG: Enough servers linked! Going to BURST-state"
         << std::endl;
    changeState(BURST);
    return;
  }
...
void chanfix::JoinChan(Channel* theChan) { MyUplink->JoinChannel(this, theChan->getName()); }

void chanfix::PartChan(Channel* theChan) { MyUplink->PartChannel(this, theChan->getName(), ""); }
...
int chanfix::getLastFix(sqlChannel* theChan) {
  ...
  /* Grab the user's host list */
  static const char* queryHeader = "SELECT ts,event FROM notes WHERE channelID = ";

  std::stringstream theQuery;
  theQuery << queryHeader << theChan->getID();
...
void chanfix::autoFix() {
  ...
  for (xNetwork::channelIterator ptr = Network->channels_begin(); ptr != Network->channels_end();
    ...
    if (thisChan->size() >= minClients && !isBeingFixed(thisChan)) {
      ...
      if (tbPtr != tempBlockList.end())
        continue;

      /* Loop through the channel list to check users for op and umode +k */
      for (Channel::userIterator ptr = thisChan->userList_begin(); ptr != thisChan->userList_end();
           ptr++) {
        curUser = ptr->second;
      ...
      if (opLess && !hasService) {
        ...
        if (!sqlChan)
          sqlChan = newChannelRecord(thisChan);
        ...
        if ((sqlChan->getMaxScore() >
            ...
            !sqlChan->getFlag(sqlChannel::F_BLOCKED) && !isTempBlocked(thisChan->getName())) {
          elog << "chanfix::autoFix> DEBUG: " << thisChan->getName() << " is opless, fixing."
               << std::endl;
...
bool chanfix::findop(sqlChanOp* curOp, sqlChannel* sqlChan) {
  for (SimMapType::iterator ptr = simMap.begin(); ptr != simMap.end(); ptr++) {
...
bool chanfix::simFix(sqlChannel* sqlChan, bool autofix, time_t c_Time, iClient* theClient,
                     sqlcfUser* theUser) {
  if (sqlChan->getSimStart() == 0)
    sqlChan->setSimStart(c_Time);
  ...
  for (chanOpsType::iterator opPtr = myOps.begin(); opPtr != myOps.end(); opPtr++) {
    ...
    if ((curOp->getPoints() + curOp->getBonus()) >= min_score) {
      ...
      std::vector<iClient*>::const_iterator acctPtr = acctToOp.begin(), end = acctToOp.end();
      while (acctPtr != end) {
        curClient = *acctPtr;
  ...
  chanStatus << "* Channel Status for " << netChan->getName() << ": " << netChan->banList_size()
             << " bans -- Restrictive Modes: +" << chanModes.str().c_str();
  ...
  if ((!numClientsToOp || maxScore < min_score) && (!autofix || !(numClientsToOp + currentOps))) {
    if (autofix && !sqlChan->getSimModesRemoved()) {
      ...
      if (netChan->banList_size() || netChan->getMode(Channel::MODE_I) ||
        ...
        SendTo(theClient,
               getResponse(theUser, language::sim_modes_removed,
                           std::string("(%s) Channel modes have been removed."))
                   .c_str(),
  ...
  if (numClientsToOp) {
    SendTo(theClient,
           getResponse(theUser, language::sim_opping, std::string("(%s) Opping: %s (%d Clients)"))
               .c_str(),
           prettyTime(c_Time).c_str(), args.c_str(), numClientsToOp);
  }

  if (numClientsToOp + currentOps >= netChan->size() || numClientsToOp + currentOps >= maxOpped)
    return true;

  return false;
}

bool chanfix::simulateFix(sqlChannel* sqlChan, bool autofix, iClient* theClient,
                          sqlcfUser* theUser) {
  bool isFixed = false;
  time_t t = getNextFix();
...
bool chanfix::fixChan(sqlChannel* sqlChan, bool autofix) {
  ...
  if (sqlChan->getFixStart() == 0)
    sqlChan->setFixStart(currentTime());
      ...
      while (acctPtr != end) {
        ...
        if (curClient && !netChan->findUser(curClient)->isModeO()) {
          elog << "chanfix::fixChan> DEBUG: Decided to op: " << curClient->getNickName() << " on "
               << netChan->getName() << ". Client has " << (curOp->getPoints() + curOp->getBonus())
               << " points. ABS_MIN = " << min_score_abs << " and REL_MIN = " << min_score_rel
               << std::endl;
          modes += "o";
          if (!args.empty())
            args += " ";
          ...
          if ((++numClientsToOp + currentOps) >= maxOpped) {
            elog << "chanfix::fixChan> DEBUG: Enough clients are to be "
                 << "opped (" << numClientsToOp << "); breaking the loop." << std::endl;
            cntMaxedOut = true;
            break;
          }
        }
  ...
  if (numClientsToOp) {
    ...
    if (numClientsToOp == 1)
      ...
      Message(netChan, "%d clients should have been opped.", numClientsToOp);
  }
...
chanfix::acctListType chanfix::findAccount(Channel* theChan, const std::string& account) {
  ...
  for (Channel::userIterator ptr = theChan->userList_begin(); ptr != theChan->userList_end();
       ptr++) {
...
bool chanfix::accountIsOnChan(const std::string& channel, const std::string& account) {
  ...
  for (Channel::userIterator ptr = tmpChan->userList_begin(); ptr != tmpChan->userList_end();
       ptr++) {
    if (account == ptr->second->getClient()->getAccount())
      return true;
  }
...
sqlChannel* chanfix::getChannelRecord(const std::string& Channel) {
  ...
  if (ptr != sqlChanCache.end()) {
    // elog << "chanfix::getChannelRecord> DEBUG: cached channel " << Channel << " found" <<
    // std::endl;
    return ptr->second;
  }
  return 0;
...
void chanfix::processQueue() {
  ...
  for (fixQueueType::iterator ptr = autoFixQ.begin(); ptr != autoFixQ.end();) {
    // elog << "chanfix::processQueue> DEBUG: Processing " << ptr->first << " in autoFixQ ..." <<
    // std::endl;
    if (ptr->second <= currentTime()) {
      sqlChannel* sqlChan = getChannelRecord(ptr->first);
      if (!sqlChan)
        sqlChan = newChannelRecord(ptr->first);
      bool isFixed = false;
      ...
      if (isFixed || currentTime() - sqlChan->getFixStart() > AUTOFIX_MAXIMUM) {
        ...
        sqlChan->setFixStart(0);
        sqlChan->setLastAttempt(0);
        elog << "chanfix::processQueue> DEBUG: Channel " << sqlChan->getChannel() << " done!"
             << std::endl;
      } else {
        ptr->second = currentTime() + AUTOFIX_INTERVAL;
        ptr++;
        elog << "chanfix::processQueue> DEBUG: Channel " << sqlChan->getChannel()
             << " not done yet ..." << std::endl;
      }
    } else
      ptr++;
  }
  ...
  for (fixQueueType::iterator ptr = manFixQ.begin(); ptr != manFixQ.end();) {
    // elog << "chanfix::processQueue> DEBUG: Processing " << ptr->first << " in manFixQ ..." <<
    // std::endl;
    if (ptr->second <= currentTime()) {
      sqlChannel* sqlChan = getChannelRecord(ptr->first);
      if (!sqlChan)
...
{
  if (updateInProgress) {
    elog << "*** [chanfix::prepareUpdate] Update already in progress; not starting." << std::endl;
    return;
  }
...
void chanfix::updateDB() {
  ...
  if (cacheCon->Tuples() && atoi(cacheCon->GetValue(0, 0))) {
    ...
    if (!cacheCon->Exec("DROP TABLE chanOpsBackup")) {
      elog << "*** [chanfix::updateDB]: Error dropping backup table: " << cacheCon->ErrorMessage()
           << std::endl;
      return;
    }
  }
  ...
  if (actualChanOpsProcessed != chanOpsProcessed) {
    ...
    logDebugMessage("ERROR: Only %d of %d chanops were updated in %u ms.", actualChanOpsProcessed,
...
void chanfix::expireTempBlocks() {
  ...
  for (tempBlockType::iterator ptr = tempBlockList.begin(); ptr != tempBlockList.end(); ptr++) {
  ...
  for (sqlChanOpsType::iterator ptr = sqlChanOps.begin(); ptr != sqlChanOps.end(); ptr++) {
    ...
    if (!ptr->second.size()) {
      ...
      if (!deleteChannelRecord(sqlChan)) {
        elog << "chanfix::rotateDB> Error: could not delete channel " << curChan.c_str()
             << std::endl;
        errorCount++;
      } else {
        deleteCount++;
...
logDebugMessage("Completed database rotation in %u ms.", rotateDBTimer.stopTimeMS());

logDebugMessage("%i channels were deleted. %i channels errored out while deleting.", deleteCount,
                errorCount);
    ...
    if (thisChan->size() >= minClients && !isBeingFixed(thisChan)) {
      ...
      for (Channel::userIterator ptr = thisChan->userList_begin(); ptr != thisChan->userList_end();
        ...
        if (curUser->isModeO() && curUser->getClient()->getAccount() != "") {
          ...
          scOpIter = std::find(scoredOpsList.begin(), scoredOpsList.end(),
...
sqlcfUser::flagType chanfix::getFlagType(const char whichChar) {
  switch (whichChar) {
  case 'a':
    return sqlcfUser::F_SERVERADMIN;
  case 'b':
    return sqlcfUser::F_BLOCK;
  case 'c':
    return sqlcfUser::F_COMMENT;
  case 'f':
    return sqlcfUser::F_CHANFIX;
  case 'o':
    return sqlcfUser::F_OWNER;
  case 'u':
    return sqlcfUser::F_USERMANAGER;
  case 'p':
    return sqlcfUser::F_PERMBLOCKER;
  }
  return 0;
}
  ...
  if (localDBHandle->Exec("SELECT language_id,topic,contents FROM help", true))
    for (unsigned int i = 0; i < localDBHandle->Tuples(); i++)
      helpTable.insert(helpTableType::value_type(
          std::make_pair(atoi(localDBHandle->GetValue(i, 0)), localDBHandle->GetValue(i, 1)),
          localDBHandle->GetValue(i, 2)));

  elog << "*** [chanfix::loadHelpTable]: Loaded " << helpTable.size() << " help messages."
       << std::endl;
...
const std::string chanfix::getResponse(sqlcfUser* theUser, int response_id, std::string msg) {
  ...
  if (localDBHandle->Exec(langQuery.str(), true))
    for (unsigned int i = 0; i < localDBHandle->Tuples(); i++)
      languageTable.insert(languageTableType::value_type(
          ...
          std::make_pair(atoi(localDBHandle->GetValue(i, 0)), localDBHandle->GetValue(i, 2))));

  elog << "*** [chanfix::loadTranslationTable]: Loaded " << languageTable.size() << " language"
       << ((languageTable.size() != 1) ? "s." : ".") << std::endl;
  ...
  if (localDBHandle->Exec(transQuery.str(), true)) {
    for (unsigned int i = 0; i < localDBHandle->Tuples(); i++) {
      ...
      translationTable.insert(
          translationTableType::value_type(thePair, localDBHandle->GetValue(i, 2)));
    }
  }

  elog << "*** [chanfix::loadTranslationTable]: Loaded " << translationTable.size()
...
void Command::Usage(iClient* theClient) {
  ...
  bot->SendTo(theClient,
              bot->getResponse(theUser, language::syntax, std::string("SYNTAX: ")).c_str() +
                  getInfo());
}
...
int chanfix::getNewScore(sqlChanOp* chOp, time_t oldestTS) {
  ...
  elog << "chanfix::getNewScore> daysSinceFirstOpOnChan: " << daysSinceFirstOpOnChan
       << " daysSinceFirstOp: " << daysSinceFirstOp << " x = " << x
       << " newScore = (x * daysSinceFirstOp) = " << newScore << " oldestTS = " << oldestTS
       << std::endl;
...
bool chanfix::doXROplist(iServer* theServer, const string& Routing, const string& Message) {
  ...
  */
  ...
  for (chanfix::chanOpsType::iterator chOp = myOps.begin(); chOp != myOps.end(); chOp++) {
    curOp = *chOp;
  ...
  for (chanfix::chanOpsType::iterator opPtr = myOps.begin();
    ...
    if (days) {
      ...
      for (int i = 1; i <= DAYSAMPLES; i++) {
        ...
        percent = static_cast<unsigned int>(
            ((static_cast<float>(cScore) / static_cast<float>(86400 / POINTS_UPDATE_TIME)) * 100) +
            0.5);
    ...
    // XREPLY
    xResponse = TokenStringsParams(
        "OPLIST %s %3d %4d  %s -- %s / %s%s%s%s%s%s", st[1].c_str(), opCount,
        (curOp->getPoints() + curOp->getBonus()), curOp->getAccount().c_str(), firstop.c_str(),
        lastop.c_str(), inChan ? " / " : "", inChan ? nickName.c_str() : "", (days) ? " [" : "",
        (days) ? dayString.str().c_str() : "", (days) ? "]" : "");
    doXResponse(theServer, Routing, xResponse);
