...
public:
   ...
   */
  inline const std::string& getUplinkName() const { return uplinkName; }

  /**
   * Return the current uplink's port.
   */
  inline unsigned short int getUplinkPort() const { return uplinkPort; }
   ...
   */
  inline void setUplinkName(const std::string& newVal) { uplinkName = newVal; }

  /**
   * Set the port on the uplink to which the bot is
   * connected or connecting.
   */
  inline void setUplinkPort(unsigned short int newVal) { uplinkPort = newVal; }

  /**
   * Set the bot's nickname.
   */
  inline void setNickName(const std::string& newVal) { nickName = newVal; }

  /**
   * Set the bot's username.
   */
  inline void setUserName(const std::string& newVal) { userName = newVal; }

  /**
   * Set the bot's real name.
   */
  inline void setRealName(const std::string& newVal) { realName = newVal; }
