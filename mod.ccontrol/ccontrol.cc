 ...
 */
extern "C" {
xClient* _gnuwinit(const string& args) { return new ccontrol(args); }
}

bool dbConnected = false;

ccontrol::ccontrol(const string& configFileName) : xClient(configFileName) {

    elog << "Initializing ccontrol version " << MAJORVER << "." << MINORVER << " please standby... "
         << endl;
    ...
    elog << Query << endl;
    elog << "ccontrol::ccontrol> Attempting to connect to " << sqlHost << "; Database: " << sqlDb
         << endl;

    SQLDb = new dbHandle(this, sqlHost, ::atoi(sqlPort.c_str()), sqlDb, sqlUser, sqlPass);
    ...
    if (SQLDb->ConnectionBad()) {
        elog << "ccontrol::ccontrol> Unable to connect to SQL server." << endl
             << "ccontrol::ccontrol> PostgreSQL error message: " << SQLDb->ErrorMessage() << endl;
    ...
    if ((limitsChan != "''") &&
        (operChans.end() == find(operChans.begin(), operChans.end(), limitsChan))) {
    ...
    RegisterCommand(new HELPCommand(this, "HELP",
                                    ...
                                    true, commandLevel::flg_HELP, false, false, true,
                                    operLevel::OPERLEVEL, false));
    RegisterCommand(new INVITECommand(this, "INVITE",
                                      "<#channel> "
                                      "\t\tRequest an invitation to a channel",
                                      false, commandLevel::flg_INVITE, false, true, false,
                                      operLevel::OPERLEVEL, false));
    RegisterCommand(new JUPECommand(this, "JUPE",
                                    "<servername> <reason> "
                                    "Jupe a server for the given reason.",
                                    false, commandLevel::flg_JUPE, false, true, false,
                                    operLevel::OPERLEVEL, false));
    RegisterCommand(new MODECommand(this, "MODE",
                                    "<channel> <modes> "
                                    "Change modes on the given channel",
                                    false, commandLevel::flg_MODE, false, true, false,
                                    operLevel::OPERLEVEL, false));
    RegisterCommand(new SCHANGLINECommand(this, "SCHANGLINE",
                                          ...
                                          true, commandLevel::flg_SCHANGLINE, false, true, false,
                                          operLevel::CODERLEVEL, true));
    RegisterCommand(new FORCECHANGLINECommand(
        this, "FORCECHANGLINE",
        "[-u] <#channel> <duration>[time units (s,d,h)] <reason> "
        "Gline a given channel for the given reason",
        true, commandLevel::flg_FORCECHANGLINE, false, true, false, operLevel::OPERLEVEL, true));
    ...
    RegisterCommand(new REMGLINECommand(this, "REMGLINE",
                                        ...
                                        true, commandLevel::flg_REMGLINE, false, true, false,
                                        operLevel::OPERLEVEL, false));
    RegisterCommand(new TOPICCommand(this, "TOPIC",
                                     "<#channel> [topic] "
                                     "Change channel topic",
                                     false, commandLevel::flg_TOPIC, false, true, false,
                                     operLevel::OPERLEVEL, false));
    RegisterCommand(new TRANSLATECommand(this, "TRANSLATE",
                                         "<numeric> "
                                         "Translate a numeric into user information",
                                         false, commandLevel::flg_TRANS, false, true, false,
                                         operLevel::OPERLEVEL, false));
    RegisterCommand(new WHOISCommand(this, "WHOIS",
                                     "<nickname> "
                                     "Obtain information on a given nickname",
                                     false, commandLevel::flg_WHOIS, false, true, false,
                                     operLevel::OPERLEVEL, false));
    RegisterCommand(new KICKCommand(this, "KICK",
                                    "<channel> <nick> <reason> "
                                    "Kick a user from a channel",
                                    false, commandLevel::flg_KICK, false, true, false,
                                    operLevel::OPERLEVEL, false));
    ...
    */
    ...
    RegisterCommand(new CHANINFOCommand(this, "CHANINFO",
                                        "<channel>"
                                        "Obtain information about a given channel",
                                        false, commandLevel::flg_CHINFO, false, true, false,
                                        operLevel::OPERLEVEL, false));
    RegisterCommand(new LOGINCommand(this, "LOGIN",
                                     "<USER> <PASS> "
                                     "Authenticate with the bot",
                                     true, commandLevel::flg_LOGIN, false, false, true,
                                     operLevel::OPERLEVEL, false));
    RegisterCommand(new DEAUTHCommand(this, "DEAUTH",
                                      ""
                                      "Deauthenticate with the bot",
                                      false, commandLevel::flg_DEAUTH, false, false, true,
                                      operLevel::OPERLEVEL, false));
    ...
    RegisterCommand(new ADDUSERCommand(this, "ADDUSER",
                                       ...
                                       "Add a new oper",
                                       true, commandLevel::flg_ADDNOP, false, true, false,
                                       operLevel::OPERLEVEL, false));
    RegisterCommand(new REMUSERCommand(this, "REMUSER",
                                       "<USER> "
                                       "Remove an oper",
                                       true, commandLevel::flg_REMOP, false, true, false,
                                       operLevel::OPERLEVEL, false));
    RegisterCommand(new ADDCOMMANDCommand(this, "ADDCOMMAND",
                                          "<USER> <COMMAND> "
                                          "Add a new command to an oper",
                                          true, commandLevel::flg_ADDCMD, false, true, false,
                                          operLevel::OPERLEVEL, false));
    RegisterCommand(new REMCOMMANDCommand(this, "REMCOMMAND",
                                          "<USER> <COMMAND> "
                                          "Remove a command from oper",
                                          true, commandLevel::flg_DELCMD, false, true, false,
                                          operLevel::OPERLEVEL, false));
    RegisterCommand(new NEWPASSCommand(this, "NEWPASS",
                                       "<PASSWORD> "
                                       "Change password",
                                       true, commandLevel::flg_NEWPASS, false, false, true,
                                       operLevel::UHSLEVEL, false));
    RegisterCommand(new SUSPENDCommand(this, "SUSPEND",
                                       "<OPER> <DURATION> [-l level] <REASON>"
                                       "Suspend an oper",
                                       true, commandLevel::flg_SUSPEND, false, true, false,
                                       operLevel::OPERLEVEL, false));
    RegisterCommand(new UNSUSPENDCommand(this, "UNSUSPEND",
                                         "<OPER> "
                                         "UnSuspend an oper",
                                         true, commandLevel::flg_UNSUSPEND, false, true, false,
                                         operLevel::OPERLEVEL, false));
    RegisterCommand(new MODUSERCommand(this, "MODUSER",
                                       "<OPER> <OPTION> <NEWVALUE> [OPTION] [NEWVALUE] ... "
                                       "Modify an oper",
                                       true, commandLevel::flg_MODOP, false, true, false,
                                       operLevel::OPERLEVEL, false));
    RegisterCommand(new MODERATECommand(this, "MODERATE",
                                        "<#Channel> "
                                        "Moderate A Channel",
                                        false, commandLevel::flg_MODERATE, false, true, false,
                                        operLevel::OPERLEVEL, false));
    RegisterCommand(new UNMODERATECommand(this, "UNMODERATE",
                                          "<#Channel> "
                                          "UNModerate A Channel",
                                          false, commandLevel::flg_UNMODERATE, false, true, false,
                                          operLevel::OPERLEVEL, false));
    RegisterCommand(new OPCommand(this, "OP",
                                  "<#Channel> <nick> [nick] .. "
                                  "Op user(s) on a Channel",
                                  false, commandLevel::flg_OP, false, true, false,
                                  operLevel::OPERLEVEL, false));
    RegisterCommand(new DEOPCommand(this, "DEOP",
                                    "<#Channel> <nick> [nick] .. "
                                    "Deop user(s) on a Channel",
                                    false, commandLevel::flg_DEOP, false, true, false,
                                    operLevel::OPERLEVEL, false));
    RegisterCommand(new LISTHOSTSCommand(this, "LISTHOSTS",
                                         "<oper> "
                                         "Shows an oper hosts list",
                                         true, commandLevel::flg_LISTHOSTS, false, true, false,
                                         operLevel::OPERLEVEL, false));
    RegisterCommand(new LISTUSERSCommand(this, "LISTUSERS",
                                         "[-l CODER/SMT/ADMIN/OPER/UHS] "
                                         "List users with specific parameters",
                                         true, commandLevel::flg_LIST, false, true, false,
                                         operLevel::OPERLEVEL, true));
    RegisterCommand(new CLEARCHANCommand(this, "CLEARCHAN",
                                         "<#chan> "
                                         "Removes all channel modes",
                                         false, commandLevel::flg_CLEARCHAN, false, true, false,
                                         operLevel::OPERLEVEL, false));
    RegisterCommand(new ADDSERVERCommand(this, "ADDSERVER",
                                         "<Server> "
                                         "Add a new server to the bot database",
                                         true, commandLevel::flg_ADDSERVER, false, true, false,
                                         operLevel::OPERLEVEL, false));
    RegisterCommand(new LEARNNETCommand(
        this, "LEARNNET",
        ""
        "Update the servers database according to the current situation",
        true, commandLevel::flg_LEARNNET, false, true, false, operLevel::OPERLEVEL, true));
    RegisterCommand(new REMSERVERCommand(this, "REMSERVER",
                                         "<Server name>"
                                         "Removes a server from the bot database",
                                         true, commandLevel::flg_REMSERVER, false, true, false,
                                         operLevel::OPERLEVEL, true));
    RegisterCommand(new CHECKNETCommand(this, "CHECKNET",
                                        ""
                                        "Checks if all known servers are in place",
                                        true, commandLevel::flg_CHECKNET, false, true, false,
                                        operLevel::OPERLEVEL, true));
    RegisterCommand(new LASTCOMCommand(this, "LASTCOM",
                                       "[number of lines to show]"
                                       "Post you the bot logs",
                                       true, commandLevel::flg_LASTCOM, false, true, false,
                                       operLevel::OPERLEVEL, true));
    ...
    RegisterCommand(new FORCEGLINECommand(this, "FORCEGLINE",
                                          ...
                                          "Gline a given user@host for the given reason",
                                          true, commandLevel::flg_FGLINE, false, true, false,
                                          operLevel::OPERLEVEL, true));
    RegisterCommand(new SGLINECommand(this, "SGLINE",
                                      "<user@host> <duration>[time units] <reason> "
                                      "Gline a given user@host for the given reason",
                                      true, commandLevel::flg_SGLINE, false, true, false,
                                      operLevel::CODERLEVEL, true));

    RegisterCommand(new REMSGLINECommand(
        this, "REMSGLINE", "<user@host> Removes a gline on a given host", true,
        commandLevel::flg_REMSGLINE, false, true, false, operLevel::CODERLEVEL, true));

    RegisterCommand(new LIMITSCommand(
        this, "LIMITS",
        "(addisp / addnetblock / delisp / delnetblock / list / chlimit / chilimit / chname / "
        "chemail / forcecount / glunidented / active / nogline / group / chccidr / clearall / "
        "userinfo / info / ipinfo)",
        true, commandLevel::flg_LIMITS, false, true, false, operLevel::OPERLEVEL, true));
    RegisterCommand(new ANNOUNCECommand(this, "ANNOUNCE", "<message>", false,
                                        commandLevel::flg_ANNOUNCE, false, false, false,
                                        operLevel::OPERLEVEL, true));
    RegisterCommand(new LISTIGNORESCommand(this, "LISTIGNORES", "List the ignore list", false,
                                           commandLevel::flg_LISTIGNORES, false, true, false,
                                           operLevel::OPERLEVEL, true));
    RegisterCommand(new REMOVEIGNORECommand(this, "REMIGNORE",
                                            "(nick/host)"
                                            " Removes a host/nick from the  ignore list",
                                            false, commandLevel::flg_REMIGNORE, false, true, false,
                                            operLevel::OPERLEVEL, true));
    RegisterCommand(new LISTCommand(this, "LIST",
                                    "(glines/servers/nomodechannels/limits/channels)"
                                    " Get all kinds of lists from the bot",
                                    false, commandLevel::flg_LIST, false, true, false,
                                    operLevel::OPERLEVEL, true));
    RegisterCommand(new COMMANDSCommand(this, "COMMANDS",
                                        "<command> <option> <new value>"
                                        " Change commands options",
                                        true, commandLevel::flg_COMMANDS, false, true, false,
                                        operLevel::OPERLEVEL, true));
    RegisterCommand(new GCHANCommand(this, "GCHAN",
                                     "#channel <length/-per> <reason>"
                                     " Set a BADCHAN gline",
                                     true, commandLevel::flg_GCHAN, false, true, false,
                                     operLevel::CODERLEVEL, true));
    RegisterCommand(new REMGCHANCommand(this, "REMGCHAN",
                                        "#channel "
    ...
    RegisterCommand(new USERINFOCommand(
        ...
        false, commandLevel::flg_USERINFO, false, true, false, operLevel::OPERLEVEL, true));
    RegisterCommand(new STATUSCommand(this, "STATUS", "Shows debug status ", false,
                                      commandLevel::flg_STATUS, false, true, false,
                                      operLevel::CODERLEVEL, true));
    RegisterCommand(new SHUTDOWNCommand(this, "SHUTDOWN", " <REASON> Shutdown the bot ", false,
                                        commandLevel::flg_SHUTDOWN, false, true, false,
                                        operLevel::CODERLEVEL, true));
    RegisterCommand(new SCANCommand(this, "SCAN",
                                    " -h <host> / -n <real name> [-v] [-i]"
                                    " Scans for all users which much a certain host / real name ",
                                    false, commandLevel::flg_SCAN, false, true, false,
                                    operLevel::OPERLEVEL, true));
    RegisterCommand(new MAXUSERSCommand(
        this, "MAXUSERS", "Shows the maximum number of online users ever recorded ", false,
        commandLevel::flg_MAXUSERS, false, true, false, operLevel::OPERLEVEL, true));
    ...
    RegisterCommand(new CONFIGCommand(
        ...
        false, commandLevel::flg_CONFIG, false, true, false, operLevel::CODERLEVEL, true));

    RegisterCommand(new NOMODECommand(
        this, "NOMODE", "<ADD/REM> <#channel> [reason]  Manage the nomode list  ", false,
        commandLevel::flg_NOMODE, false, true, false, operLevel::SMTLEVEL, true));

    RegisterCommand(new SAYCommand(
        this, "SAY", "<-s/-b> <#chan/nick> Forced the bot to \"talk\" as the uplink or the bot",
        false, commandLevel::flg_SAY, false, true, false, operLevel::CODERLEVEL, true));
    RegisterCommand(new SAYCommand(
        this, "DO", "<-s/-b> <#chan/nick> Forces the bot to \"/me\" as the uplink or the bot",
        false, commandLevel::flg_SAY, false, true, false, operLevel::CODERLEVEL, true));
    RegisterCommand(new REOPCommand(this, "REOP",
                                    "<#chan> <nick> "
                                    "Removes all channel ops, and reops the specified nick",
                                    false, commandLevel::flg_REOP, false, true, false,
                                    operLevel::OPERLEVEL, false));

    RegisterCommand(new UNJUPECommand(this, "UNJUPE", "<server> removes a jupiter on a server",
                                      false, commandLevel::flg_UNJUPE, false, true, false,
                                      operLevel::OPERLEVEL, true));
...
bool ccontrol::BurstGlines() {
    ccGline* theGline = 0;
    for (glineListType::iterator ptr = glineList.begin(); ptr != glineList.end(); ++ptr) {
        theGline = ptr->second;
        addGlineToUplink(theGline);
    }

    for (glineListType::iterator ptr = rnGlineList.begin(); ptr != rnGlineList.end(); ++ptr) {
        theGline = ptr->second;
        addGlineToUplink(theGline);
    }
...
void ccontrol::OnPrivateMessage(iClient* theClient, const string& Message, bool) {
    ...
    if ((!theUser) && !(ComAccess & commandLevel::flg_NOLOGIN) &&
        (ComAccess)) { // The user isnt authenticated,
    ...
    if ((theUser) && (!theClient->isOper()) && (theUser->getNeedOp())) {
        if ((!theUser->getAutoOp()) || (strcasecmp("LOGIN", Command))) {
            if (!theClient->getMode(iClient::MODE_SERVICES))
                Notice(theClient, "You must be oper'd to use this command");
            xClient::OnPrivateMessage(theClient, Message);
            return;
        }
        ...
        if (theClient->getMode(iClient::MODE_SERVICES) && theClient->isOper())
            Notice(theClient, "Sorry, you are suspended");
    } else if (commHandler->second->getIsDisabled()) {
        if (!theClient->getMode(iClient::MODE_SERVICES) && theClient->isOper())
            Notice(theClient, "Sorry, this command is currently disabled");
    } else {
...
void ccontrol::OnServerMessage(iServer* Server, const string& Message, bool) {
    StringTokenizer st(Message);
    ...
    if (!strcasecmp(st[1], "RO")) {
        if (st.size() < 7) {
            elog << "ccontrol::OnServerMessage> Invalid number "
                 << "on parameters on RO! :" << Message << endl;
    ...
    if (!strcasecmp(st[1], "391")) {
        ...
        if (st.size() < 5) {
            elog << "ccontrol::OnServerMessage> Invalid number "
                 << "on parameters on 391! :" << Message << endl;
        ...
        if ((timeDiff >= MAX_TIME_DIFF) && (lagTime < 5000) &&
            ((::time(0) - timediffServersMap[Server->getName()]) > TIMEDIFF_REPORT_INTERVAL)) {
    ...
    if (!strcasecmp(st[1], "351")) {
        if (st.size() < 5) {
            elog << "ccontrol::OnServerMessage> Invalid number "
                 << "on parameters on 351! :" << Message << endl;
...
void ccontrol::OnCTCP(iClient* theClient, const string& CTCP, const string& Message, bool) {
    ccUser* theUser = IsAuth(theClient);
    if ((!theUser) && !(theClient->isOper())) { // We need to add the flood points for this user
        if (!theClient->getCustomData(this)) {
            elog << "ccontrol::OnCTCP> Couldnt find custom data for " << *theClient << endl;
            return;
        }

        ccFloodData* floodData =
            (static_cast<ccUserData*>(theClient->getCustomData(this)))->getFlood();
        if (floodData->addPoints(flood::CTCP_POINTS)) { // yes we need to ignore this user
            ignoreUser(floodData);
            MsgChanLog("[FLOOD MESSAGE]: %s has been ignored", theClient->getNickName().c_str());
            return;
        }
    } else {
        ...
        if (st.empty()) {
            ...
            xClient::DoCTCP(theClient, CTCP, "Sorry i am booked till the end of the year");
            return;
        } else if (st[0] == "POLICE") {
            xClient::DoCTCP(theClient, CTCP, "Oh crap! where would i hide the drugs now?");
            return;
        } else if (st[0] == "VERSION") {
            xClient::DoCTCP(theClient, CTCP,
                            " CControl version " + string(MAJORVER) + "." + string(MINORVER) +
...
void ccontrol::OnTimer(const xServer::timerID& timer_id, void*) {
...
#endif
    {
        ...
        if (ccHub)
            if ((ccHub->getLastLagSent() > ccHub->getLastLagRecv()) &&
                ((::time(0) - ccHub->getLastLagSent()) >= 2))
        ...
        for (serversconstiterator ptr = serversMap_begin(); ptr != serversMap_end(); ++ptr) {
            ...
            if (TmpServer && (TmpServer->getNetServer()) &&
                (!TmpServer->getNetServer()->isJupe())) {
                counter++;
                if ((TmpServer->getLastLagRecv() > 0) &&
                    (TmpServer->getLastLagSent() > TmpServer->getLastLagRecv())) {
                    ...
                    if ((::time(0) - TmpServer->getLastLagSent()) >= MAX_LAG_TIME) {
                        if ((::time(0) - TmpServer->getLastLagReport()) > LAG_REPORT_INTERVAL) {
                            // If it's euworld's hub that is lagged, only report euworld's hub, not
                            // every servers.
                            if ((ccHub == NULL) || (ccHub->getLagTime() < 14000) ||
                                (TmpServer->getNetServer()->getIntYY() == myHub->getIntYY())) {
                                TmpServer->setLastLagReport(::time(0));
                                MsgChanLag("[lag] %s is >%ds lagged", TmpServer->getName().c_str(),
                                           (int)(TmpServer->getLagTime() / 1000));
                                elog << "ccontrol(rpingCheck)> DEBUG: "
                                     << TmpServer->getName().c_str() << " >"
                                     << (TmpServer->getLagTime() / 1000)
                                     << "s lag getLastLagSent()=" << TmpServer->getLastLagSent()
                                     << " getLastLagRecv()=" << TmpServer->getLastLagRecv()
                                     << " now=" << ::time(0) << endl;
                            }
                        }
                    }
...
bool ccontrol::isOperChan(const string& theChan) const {
    vector<string>::const_iterator ptr = operChans.begin(), end = operChans.end();
    while (ptr != end) {
...
bool ccontrol::Join(const string& chanName, const string& chanModes, const time_t& joinTime,
                    bool getOps) {
...
bool ccontrol::Part(const string& chanName, const string& reason) {
    ...
    for (vector<string>::iterator ptr = operChans.begin(); ptr != operChans.end(); ++ptr) {
...
bool ccontrol::addOperChan(const string& chanName) { return addOperChan(chanName, operChanReason); }
...
bool ccontrol::addOperChan(const string& chanName, const string& reason) {
    ...
    if (NULL == theChan) {
        elog << "ccontrol::addOperChan> Unable to find channel: " << chanName << endl;
        return false;
    }
    ...
    for (Channel::const_userIterator ptr = theChan->userList_begin();
        ...
        if ((!ptr->second->isOper()) &&
            (!ptr->second->getClient()->getMode(iClient::MODE_SERVICES))) {
...
void ccontrol::handleAC(iClient* theClient) {
    ...
    if (theUser->getAccountID() != theClient->getAccountID()) {
        if ((theUser->getAccountID() != 0) && (theClient->getAccountID() != 0)) {
            elog << "ccontrol::handleAC()> getAccount mismatch for " << theClient->getAccount()
                 << ". theClient->getAccountID() = " << theClient->getAccountID()
                 << " && theUser->getAccountID() = " << theUser->getAccountID() << endl;
            return;
        }
    }
    if (!theUser->getSso())
    ...
    if (!theClient->isOper()) {
        ...
        if ((!UserGotMask(theUser, theClient->getRealNickUserHost())) &&
            (!UserGotMask(theUser, theClient->getNickName() + "!" + theClient->getUserName() + "@" +
    ...
    if ((theUser->getAccountID() != theClient->getAccountID()) && (theUser->getAccountID() == 0)) {
        ...
        theUser->Update();
        Notice(theClient,
               "Your X account ID (%d) is now stored in my database along with your X account.",
               theClient->getAccountID());
        Notice(theClient, "This ensures that if your username expires and gets re-registered, I "
                          "will see the difference. You should never see this message again");
    }
...
void ccontrol::OkAuthUser(iClient* theClient, ccUser* theUser) {
    ...
    if (AuthUser(theUser, theClient))
        if (!(isSuspended(theUser)))
            ...
            Notice(theClient,
                   "Authentication successful as %s, "
    ...
    for (Itr = Clients.begin(); Itr != Clients.end(); Itr++) {
        ...
        if (tClient != theClient) // there is already a user authenticated under that nick
        {
            count++;
            if (count == 1) {
                Notice(theClient, "The following clients are already authenticated as %s:",
                       theUser->getUserName().c_str());
            }
            iClient* tClient = *Itr;
            Notice(tClient, "New authentification as you (%s) by %s",
                   theUser->getUserName().c_str(), theClient->getRealNickUserHost().c_str());
            StringTokenizer st(tClient->getServer()->getName(), '.');
            Notice(theClient, "    %s (%s.*)", tClient->getRealNickUserHost().c_str(),
                   st[0].c_str());
        }
    }
...
void ccontrol::handleNewClient(iClient* NewUser) {
    ...
    NewUser->setCustomData(this, static_cast<void*>(UserData));
    if (NewUser->isOper())
        isNowAnOper(NewUser);
    if (NewUser->isModeR()) {
        handleAC(NewUser);
    ...
    if (dbConnected) {
        ...
        if (irc_in_addr_valid(&NewUser->getIP())) // avoid 0:: (0.0.0.0) ip addresses
        {
            ...
            for (iItr = ipLRecentIauthList.begin(); iItr != ipLRecentIauthList.end();) {
                ...
                if (age > iauthTimeout) {
                    if (!strcasecmp(xIP(tClient->getIP()).GetNumericIP(),
                                    xIP(NewUser->getIP()).GetNumericIP())) {
                ...
                if (!strcasecmp(xIP(tClient->getIP()).GetNumericIP(),
                    ...
                    // assert(st.size() > 1);
                    if (!strncmp(st[0].c_str(), NewUser->getCharYY().c_str(), 2)) {
                        // elog << "ccontrol> handleNewClient(): ipL iauth client match: " <<
                        // NewUser->getNickUserHost().c_str() << endl;
                        ipLDropClient(tClient);
                        iItr = ipLRecentIauthList.erase(iItr);
                        delete tClient;
                        break;
            ...
            for (ipLretStructListType::iterator lItr = retList.begin(); lItr != retList.end();
                 lItr++) {
                ...
                bool group = false;
                nbstring = rs.mask;
                // elog << "ccontrol::handleNewClient> DEBUG: nb->ipLisp->isGlunidented()=" <<
                // nb->ipLisp->isGlunidented() << ", NewUser->getUserName().substr(0,1)=" <<
                // NewUser->getUserName().substr(0,1) << endl;
                if (nb->ipLisp->isGroup()) {
                    group = true;
                    netblock = nb->getCidr();
                    // elog << "ccontrol::handleNewClient> group nb=" << netblock << ", nbstring="
                    // << nbstring
                ...
                if (!ipLRetVal && nb->isActive()) {
                    ...
                    for (ipLnbVectorType::iterator nItr = ipLnbVector.begin();
                         nItr != ipLnbVector.end(); nItr++) {
                        if (group) {
                            nb = nItr->second;
                        ...
                        if (nb->isNoGline()) {
                            ...
                            if (rs.type != 'd') {
                                ...
                                if ((rs.type != 'd') &&
                                    ((Itr = ExcessiveConnNotif.find(GlineMask)) ==
                                         ExcessiveConnNotif.end() ||
                                     (::time(0) - Itr->second.lastReportTS) >=
                                         ExcessConnReportInterval ||
                                     (ipLconncount - Itr->second.lastReportCount) >= 100)) {
                                    MsgChanLog("Excessive connections%s from subnet %s [ref: %s's "
                                               "%s] (will _NOT_ GLINE)",
                                               glineLimit, GlineMask, nb->ipLisp->getName().c_str(),
                                               nb->getCidr().c_str());
                            ...
                            elog << "mod.ccontrol::HandleNewClient()> Gline exists on "
                                 << exGline->getHost() << " and is <30 secs old. Not readding"
                                 << endl;
                        } else {
                            sprintf(Log, "Glining %s for %s connections%s [ref: %s's %s]",
                                    GlineMask, glineType, glineLimit, nb->ipLisp->getName().c_str(),
                                    nb->getCidr().c_str());
                            AffectedUsers = ipLconncount;
                            /* set the gline reason */
                            if (isUserban) {
                                sprintf(GlineReason,
                                        "AUTO [%d] %sAutomatically banned for excessive IDENT "
                                        "connections (%s@)%s",
                                        AffectedUsers,
                                        group ? string("[" + nb->ipLisp->getName() + "] ").c_str()
                                              : "",
                                        user.c_str(), url_excessive_conn.c_str());
                            } else if (isUnidentedBan) {
                                sprintf(GlineReason,
                                        "AUTO Please make sure identd is installed and properly "
                                        "configured on your router and/or firewall to allow "
                                        "connections from the internet on port 113 before you "
                                        "reconnect%s",
                                        url_install_identd.c_str());
                            } else {
                                sprintf(
                                    GlineReason,
                                    "AUTO [%d] %sAutomatically banned for excessive connections%s",
                                    AffectedUsers,
                                    group ? string("[" + nb->ipLisp->getName() + "] ").c_str() : "",
    ...
    if (!IsAuth(NewUser)) {
        ...
        // TODO: Fix auto auth after netsplit. It will only work if it's the latest client that
        // authed that splits.
            ...
            if ((tUser->getLastAuthTS() == NewUser->getNickTS()) &&
                ...
                if (AuthUser(tUser, NewUser))
                    if (!(isSuspended(tUser)))
                        Notice(NewUser, "Automatic authentication after netsplit successful!",
                               tUser->getUserName().c_str());
                    else
                        Notice(NewUser,
                               "Automatic authentication after netsplit successful, however you "
                               "are suspended",
                               tUser->getUserName().c_str());
                else
                    Notice(NewUser, "Error in authentication", tUser->getUserName().c_str());
                MsgChanLog("(%s) - %s: AUTO-AUTHENTICATED (after netsplit)\n",
                           tUser->getUserName().c_str(), NewUser->getRealNickUserHost().c_str());
                vector<iClient*>::const_iterator Itr;
                ...
                for (Itr = Clients.begin(); Itr != Clients.end(); Itr++) {
                    ...
                    if (tClient != NewUser) // there is already a user authenticated under that nick
                    {
                        ...
                        if (count == 1) {
                            Notice(NewUser,
                                   "The following clients are already authenticated as %s:",
                                   tUser->getUserName().c_str());
                        }
                        iClient* tClient = *Itr;
                        Notice(tClient, "New authentification as you (%s) by %s",
                        ...
                        StringTokenizer st(tClient->getServer()->getName(), '.');
                        Notice(NewUser, "    %s (%s.*)", tClient->getRealNickUserHost().c_str(),
                               st[0].c_str());
                    }
                }
...
ccUser* ccontrol::IsAuth(const string& Numeric) { return IsAuth(Network->findClient(Numeric)); }

bool ccontrol::AddOper(ccUser* Oper) {
    static const char* Main =
        "INSERT INTO opers "
        "(user_name,password,access,saccess,last_updated_by,last_updated,flags,server,isSuspended,"
        "suspend_expires,suspended_by,suspend_level,suspend_reason,isUhs,isOper,isAdmin,isSmt,"
        "isCoder,GetLogs,NeedOp,Notice,GetLag,LastPassChangeTS,Sso,Ssooo,AutoOp,Account,AccountTS) "
        "VALUES ('";
    ...
    theQuery << Main << escapeSQLChars(Oper->getUserName()) << "','"
             << escapeSQLChars(Oper->getPassword()) << "'," << Oper->getAccess() << ","
             << Oper->getSAccess() << ",'" << escapeSQLChars(Oper->getLast_Updated_by())
             << "',date_part('epoch', CURRENT_TIMESTAMP)::int," << Oper->getFlags() << ",'"
             << escapeSQLChars(Oper->getServer()) << "' ,"
             << (Oper->getIsSuspended() ? "'t'" : "'n'") << "," << Oper->getSuspendExpires() << ",'"
             << escapeSQLChars(Oper->getSuspendedBy()) << "'," << Oper->getSuspendLevel() << ",'"
             << escapeSQLChars(Oper->getSuspendReason()) << "'," << (Oper->isUhs() ? "'t'" : "'n'")
             << "," << (Oper->isOper() ? "'t'" : "'n'") << "," << (Oper->isAdmin() ? "'t'" : "'n'")
             << "," << (Oper->isSmt() ? "'t'" : "'n'") << "," << (Oper->isCoder() ? "'t'" : "'n'")
             << "," << (Oper->getLogs() ? "'t'" : "'n'") << ","
             << (Oper->getNeedOp() ? "'t'" : "'n'") << "," << (Oper->getNotice() ? "'t'" : "'n'")
             << "," << (Oper->getLag() ? "'t'" : "'n'")
             << ",date_part('epoch', CURRENT_TIMESTAMP)::int"
             << "," << (Oper->getSso() ? "'t'" : "'n'") << "," << (Oper->getSsooo() ? "'t'" : "'n'")
             << "," << (Oper->getAutoOp() ? "'t'" : "'n'") << ",'"
             << escapeSQLChars(Oper->getAccount()) << "'," << Oper->getAccountID() << ")" << ends;
    ...
    elog << "ccontrol::AddOper> SQL Failure: " << SQLDb->ErrorMessage()
         << "Query was:  " << theQuery.str() << endl;
    return false;
}
...
#ifdef LOG_SQL
        elog << "ccontrol::DeleteOper> " << HostQ.str().c_str() << endl;
#endif
        if (!SQLDb->Exec(HostQ))
        // if( PGRES_COMMAND_OK != status )
        {
            elog << "ccontrol::DeleteOper> SQL Failure: " << SQLDb->ErrorMessage() << endl;
            return false;
        }
...
#ifdef LOG_SQL
    elog << "ccontrol::DeleteOper> " << theQuery.str().c_str() << endl;
#endif
...
bool ccontrol::AuthUser(ccUser* TempUser, iClient* theClient) {
    if (!theClient->getCustomData(this)) {
        elog << "Couldnt find custom data for " << theClient->getNickName() << endl;
        return false;
    }
    ...
    for (Itr = Clients.begin(); Itr != Clients.end(); Itr++) {
        ...
        if (tClient == theClient) {
            if (!tClient->getCustomData(this)) {
                elog << "Couldnt find custom data for " << tClient->getNickName() << endl;
                return false;
            }
...
bool ccontrol::UserGotMask(ccUser* user, const string& Host) {
    ...
    stringstream theQuery;
    theQuery << Main << user->getID() << ';' << ends;

#ifdef LOG_SQL
    elog << "ccontrol::UserGotMask> " << theQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(theQuery, true))
    // if( PGRES_TUPLES_OK != status )
    {
        elog << "ccontrol::UserGotMask> SQL Failure: " << SQLDb->ErrorMessage() << endl;
...
#ifdef LOG_SQL
    elog << "ccontrol::UserGotHost> " << theQuery.str().c_str() << endl;
#endif
...
bool ccontrol::AddHost(ccUser* user, const string& host) {
    ...
    stringstream theQuery;
    theQuery << Main << user->getID() << ",'" << escapeSQLChars(host) << "')" << ends;

#ifdef LOG_SQL
    elog << "ccontrol::AddHost> " << theQuery.str().c_str() << endl;
#endif
    ...
    // if( PGRES_COMMAND_OK == status )
    {
        ...
        elog << "ccontrol::AddHost> SQL Error: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
}
...
bool ccontrol::DelHost(ccUser* user, const string& host) {
    ...
    stringstream theQuery;
    theQuery << Main << user->getID() << " And host = '" << escapeSQLChars(host) << "'" << ends;

#ifdef LOG_SQL
    elog << "ccontrol::DelHost> " << theQuery.str().c_str() << endl;
#endif
    ...
    // if( PGRES_COMMAND_OK == status )
    {
        ...
        elog << "ccontrol::DelHost> SQL Error: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
}

bool ccontrol::listHosts(ccUser* User, iClient* theClient) {
    static const char* queryHeader = "SELECT host FROM hosts WHERE user_id =  ";
    ...
    stringstream theQuery;
    theQuery << queryHeader << User->getID() << ends;

    if (!SQLDb->Exec(theQuery, true))
    // if( PGRES_TUPLES_OK != status )
    {
        elog << "LISTHOSTS> SQL Error: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
...
bool ccontrol::GetHelp(iClient* user, const string& command) {
    ...
    stringstream theQuery;
    theQuery << Main << string_lower(escapeSQLChars(command)) << "' ORDER BY line" << ends;

#ifdef LOG_SQL
    elog << "ccontrol::GetHelp> " << theQuery.str().c_str() << endl;
#endif
    ...
    // if( PGRES_TUPLES_OK == status )
    {
        if (SQLDb->Tuples() > 0) {
            ...
            Notice(user, "Couldn't find help for %s", command.c_str());
        }
        return true;
    } else {
        elog << "ccontrol::GetHelp> SQL Error: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
}
...
bool ccontrol::GetHelp(iClient* user, const string& command, const string& subcommand) {
    ...
    stringstream theQuery;
    theQuery << Main << string_lower(escapeSQLChars(command)) << "' and lower(subcommand) = '"
             << string_lower(escapeSQLChars(subcommand)) << "' ORDER BY line" << ends;
...
void ccontrol::DoHelp(iClient* theClient) {
    for (unsigned int i = 0; i < SQLDb->Tuples(); i++) {
        string commInfo = replace(SQLDb->GetValue(i, 1), "$BOT$", nickName);
        Notice(theClient, "%s", commInfo.c_str());
    } // for()
}

string ccontrol::replace(const string& srcString, const string& from, const string& to) {
...
ccGline* ccontrol::findMatchingGline(const iClient* theClient) {
    ...
    for (glineIterator ptr = glineList.begin(); ptr != glineList.end(); ++ptr) {
        theGline = ptr->second;
        if ((match(theGline->getHost(), Host) == 0) || ((match(theGline->getHost(), IP) == 0))) {
...
struct tm ccontrol::convertToTmTime(time_t NOW) { return *gmtime(&NOW); }
...
bool ccontrol::DailyLog(ccUser* Oper, const char* Log, ...) {
    ...
    if (NULL == targetServer) {
        elog << "ccontrol:> Unable to find server: " << theClient->getIntYY() << endl;
        return false;
    }

    buffer[512] = 0;
    static const char* Main =
        "INSERT INTO comlog (ts,oper,command) VALUES (date_part('epoch', CURRENT_TIMESTAMP)::int,'";
    ...
    if (tCommand != command_end()) {
        if (!strcasecmp(tCommand->second->getRealName(), "LOGIN")) {
            if (st.size() > 1)
                log.assign(string("LOGIN ") + st[1] + string(" *****") + string(" (") +
                           targetServer->getName() + string(")"));
    ...
    theQuery << " (" << escapeSQLChars(theClient->getRealNickUserHost()) << ")','"
             << escapeSQLChars(buffer) << "')" << ends;

#ifdef LOG_SQL
    elog << "ccontrol::DailyLog> " << theQuery.str().c_str() << endl;
#endif
    ...
    // if( PGRES_COMMAND_OK == status )
    {
        ...
        elog << "ccontrol::DailyLog> SQL Error: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
...
bool ccontrol::DailyLog(ccLog* newLog) {
    ...
    if (LogFile.bad()) { // There was a problem in opening the log file
...
bool ccontrol::CreateReport(time_t From, time_t Til) {
    ...
    stringstream theQuery;
    theQuery << queryHeader << From << " AND ts < " << Til << " ORDER BY ts DESC" << ends;

#ifdef LOG_SQL
    elog << "ccontrol::CreateReport> " << theQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(theQuery, true))
    // if( PGRES_TUPLES_OK != status )
    {
        elog << "ccontrol::CreateReport> SQL Error: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
    ...
    tLogFile << "ccontrol log for command issued between " << convertToAscTime(From)
             << " and up til " << convertToAscTime(Til) << endl;

    for (unsigned int i = 0; i < SQLDb->Tuples(); i++) {
        tLogFile << "[ " << convertToAscTime(atoi(SQLDb->GetValue(i, 0).c_str())) << " - "
                 << SQLDb->GetValue(i, 1) << " ] " << SQLDb->GetValue(i, 2) << endl;
    }

    tLogFile << "End of debug log" << endl;
...
int ccontrol::checkSGline4(string& Host, unsigned int Len, unsigned int& Affected) {
    ...
    for (string::size_type pos = 0; pos < Ident.size(); ++pos) {
        if ((Ident[pos] == '*') || (Ident[pos] == '?')) {
            continue;
        } else { // Its not */? so we have a legal ident
            hasId = true;
            break;
        }
    }
...
bool ccontrol::refreshSuspention() {
    ...
    static const char* DelMain =
        "UPDATE opers SET isSuspended = 'n',Suspend_Expires = 0, Suspended_by = '',suspend_level = "
        "0,suspend_reason='' WHERE IsSuspended = 'y' AND suspend_expires < date_part('epoch', "
        "CURRENT_TIMESTAMP)::int";

    stringstream DelQuery;
    DelQuery << DelMain << ends;
#ifdef LOG_SQL
    elog << "ccontrol::RefreshSuspention> " << DelQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(DelQuery))
    // if( PGRES_COMMAND_OK != status )
    {
        elog << "ccontrol::refreshSuspention> SQL Failure: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
    if (totalCount > 0)
...
bool ccontrol::processGlineQueue() {
    ...
    for (unsigned int i = 0;
         i < (glineQueue.size() > glineBurstCount ? glineBurstCount : glineQueue.size()); ++i) {
...
bool ccontrol::loadGlines() {
    // static const char *Main = "SELECT * FROM glines WHERE ExpiresAt > date_part('epoch',
    // CURRENT_TIMESTAMP)::int";
...
#ifdef LOG_SQL
    elog << "ccontrol::loadGlines> " << theQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(theQuery, true))
    // if( PGRES_TUPLES_OK != status )
    {
        elog << "ccontrol::loadGlines> SQL Failure: " << SQLDb->ErrorMessage() << endl;
...
bool ccontrol::loadUsers() {
    ...
    stringstream theQuery;
    theQuery << User::Query << ends;

#ifdef LOG_SQL
    elog << "ccotrol::loadUsers> " << theQuery.str().c_str() << endl;
#endif
...
bool ccontrol::loadServers() {
    ...
    stringstream theQuery;
    theQuery << server::Query << ends;

#ifdef LOG_SQL
    elog << "ccotrol::loadServers> " << theQuery.str().c_str() << endl;
#endif
...
bool ccontrol::loadMaxUsers() {
    ...
    stringstream theQuery;
    theQuery << "SELECT * FROM misc WHERE VarName = 'MaxUsers';" << ends;

#ifdef LOG_SQL
    elog << "ccotrol::loadMaxUsers> " << theQuery.str().c_str() << endl;
#endif
    ...
    if (SQLDb->Tuples() == 0) {
        ...
        insertQ << "INSERT INTO misc (VarName,Value1,Value2) VALUES ('MaxUsers',0,0);" << ends;
...
bool ccontrol::loadBadChannels() {
    ...
    stringstream theQuery;
    theQuery << badChannels::Query << ends;

#ifdef LOG_SQL
    elog << "ccotrol::loadBadChannels> " << theQuery.str() << endl;
#endif
...
bool ccontrol::loadMisc() {
    ...
    stringstream theQuery;
    theQuery << "SELECT * FROM misc" << ends;

#ifdef LOG_SQL
    elog << "ccotrol::loadMisc()> " << theQuery.str().c_str() << endl;
#endif
...
int ccontrol::isGlinedException(const string& Host) {
    for (glinedExceptionListType::iterator ptr = glinedExceptionList.begin();
         ptr != glinedExceptionList.end();) {
...
bool ccontrol::isCidrMatch(const string& cidrmask1, const string& cidrmask2) {
    ...
    i = sscanf(tIP.c_str(), "%d.%d.%d.%d", &client_addr[0], &client_addr[1], &client_addr[2],
               &client_addr[3]);
    mask_ip = ntohl((client_addr[0]) | (client_addr[1] << 8) | (client_addr[2] << 16) |
                    (client_addr[3] << 24));
...
bool ccontrol::isValidCidr(const string& cidrmask) {
    ...
    /* CIDR checks */
    /* convert ip to longip */
    i = sscanf(st[0].c_str(), "%d.%d.%d.%d", &client_addr[0], &client_addr[1], &client_addr[2],
               &client_addr[3]);
    mask_ip = ntohl((client_addr[0]) | (client_addr[1] << 8) | (client_addr[2] << 16) |
                    (client_addr[3] << 24));
    /* bitshift ip to strip the last (32-cidrmask) bits (leaving a mask for the ip) */
...
void ccontrol::addLogin(iClient* tClient) {
    if (!tClient->getCustomData(this)) {
        elog << "Couldn't find custom data for " << tClient->getNickName() << endl;
        return;
    }
...
void ccontrol::addFloodData(iClient* theClient, unsigned int /*floodPoints*/) {
    ...
    ccFloodData* floodData = (static_cast<ccUserData*>(theClient->getCustomData(this)))->getFlood();
...
int ccontrol::removeIgnore(iClient* theClient) {
    string Host =
        string("*!*") + theClient->getUserName() + string("@") + theClient->getRealNickUserHost();
...
bool ccontrol::listIgnores(iClient* theClient) {
    ...
    for (ignoreIterator ptr = ignore_begin(); ptr != ignore_end(); ptr++) {
        ...
        if (tempLogin->getIgnoreExpires() > ::time(0)) {
            Notice(theClient, "Host: %s Expires: %s [%ld]", tempLogin->getIgnoredHost().c_str(),
...
void ccontrol::listGlines(iClient* theClient, string Mask) {
    ...
    for (glineIterator ptr = gline_begin(); ptr != gline_end(); ++ptr) {
        tempGline = ptr->second;
        if ((tempGline->getExpires() > ::time(0)) && (!match(Mask, tempGline->getHost()))) {
            ...
            Notice(theClient, "Host: %s, Expires: [%ld] %s, Added by %s at [%ld] %s ago",
                   ...
                   tempGline->getAddedOn(), gline_set);
        }
    }
    ...
    for (serversconstiterator ptr = serversMap_begin(); ptr != serversMap_end(); ++ptr) {
        ...
        if (tmpServer->getNetServer()) {
            ...
            snprintf(buf, sizeof(buf) - 1, "%3s (%4d) Name: %s Version: %s",
                     ...
                     base64toint(tmpServer->getLastNumeric().c_str()), tmpServer->getName().c_str(),
            ...
            Notice(theClient, "           Name: %s Version: %s", tmpServer->getName().c_str(),
                   tmpServer->getVersion().c_str());
        }
    }
}
...
#ifdef LOG_SQL
    elog << "ccontrol::loadCommands> " << theQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(theQuery, true))
    // if( PGRES_TUPLES_OK != status )
    {
        elog << "ccontrol::loadCommands> SQL Failure: " << SQLDb->ErrorMessage() << endl;
...
bool ccontrol::updateCommand(Command* Comm) {
    ...
    theQuery.str("");
    if (update) {
        theQuery << Main << escapeSQLChars(Comm->getName())
                 << "', isDisabled = " << (Comm->getIsDisabled() ? "'t'" : "'n'")
                 << ", NeedOp = " << (Comm->getNeedOp() ? "'t'" : "'n'")
                 << ", NoLog = " << (Comm->getNoLog() ? "'t'" : "'n'")
                 << ", MinLevel = " << Comm->getMinLevel() << " WHERE lower(RealName) = '"
                 << string_lower(escapeSQLChars(Comm->getRealName())) << "'" << ends;

    } else {
        theQuery << "INSERT into Commands "
                    "(RealName,Name,Flags,IsDisabled,NeedOp,NoLog,MinLevel,SAccess) VALUES (";
...
#ifdef LOG_SQL
    elog << "ccontrol::updateCommands> " << theQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(theQuery))
    // if( PGRES_COMMAND_OK != status )
    {
        elog << "ccontrol::updateCommands> SQL Failure: " << SQLDb->ErrorMessage() << endl;
...
bool ccontrol::UpdateCommandFromDb(Command* Comm) {
    ...
    stringstream theQuery;
    theQuery << Main << string_lower(escapeSQLChars(Comm->getRealName())) << "'" << ends;

    if (!SQLDb->Exec(theQuery, true))
    // if( PGRES_TUPLES_OK != status )
    {
        elog << "ccontrol::LoadCommand> SQL Failure: " << SQLDb->ErrorMessage() << endl;
...
void ccontrol::showStatus(iClient* tmpClient) {
    ...
    Notice(tmpClient, "ccServer: %d, ccGline: %d, ccUser: %d, ccIpLisp: %d, ccIpLnb: %d",
           ccServer::numAllocated, ccGline::numAllocated, ccUser::numAllocated,
           ccIpLisp::numAllocated, ccIpLnb::numAllocated);
    Notice(tmpClient, "Total of %d users in the map", usersMap.size());
    Notice(tmpClient, "(Gline Burst) - GBCount: %d , GBInterval: %d", glineBurstCount,
           glineBurstInterval);
...
bool ccontrol::updateMisc(const string& varName, const unsigned int Value) {
    ...
    stringstream theQuery;
    theQuery << "SELECT * FROM misc WHERE VarName = '" << varName << "'" << ends;

#ifdef LOG_SQL
    elog << "ccotrol::updateMisc> " << theQuery.str().c_str() << endl;
#endif
    ...
    if (SQLDb->Tuples() == 0) {
        stringstream insertQ;
        insertQ << "INSERT INTO misc (VarName,Value1) VALUES ('" << varName << "'," << Value << ")"
                << ends;
        ...
        updateQ << "UPDATE misc SET Value1 = " << Value << " WHERE VarName = '" << varName << "'"
                << ends;
...
void ccontrol::showLogs(iClient* theClient, unsigned int Amount) {
    if (Amount > LogsToSave) {
        Notice(theClient, "Sorry, but you can't view more than the last %d commands", LogsToSave);
        Amount = LogsToSave;
    }

    if ((LogList.size() < Amount) && ((NumOfLogs > LogList.size()) || (NumOfLogs == 0))) {
    ...
    while (Left > 0) {
        Notice(theClient, "[%s] - [(%s) - %s] - %s", convertToAscTime((*curLog)->Time),
               (*curLog)->User.c_str(), (*curLog)->Host.c_str(), (*curLog)->Desc.c_str());
        --curLog;
        Left--;
    }
}
...
void ccontrol::saveServersInfo() {
    ...
    gnuworld::xNetwork::const_serverIterator sIterator = Network->servers_begin();
    iServer* curServer;
    for (; sIterator != Network->servers_end(); ++sIterator) {
        curServer = sIterator->second;
        if (!curServer)
            continue;
        servFile << curServer->getName().c_str() << " " << curServer->getConnectTime() << " "
                 << Network->countClients(curServer) << endl;
    }
    servFile.close();
}
...
void ccontrol::saveChannelsInfo() {
    ...
    gnuworld::xNetwork::const_channelIterator cIterator = Network->channels_begin();
    Channel* curChannel;
    for (; cIterator != Network->channels_end(); ++cIterator) {
        curChannel = cIterator->second;
        if (!curChannel)
            continue;
        chanFile << curChannel->getName() << " " << curChannel->getCreationTime() << " "
                 << curChannel->getModeString() << " " << curChannel->size()
#ifdef TOPIC_TRACK
                 << " " << curChannel->getTopic()
#endif
                 << endl;
...
void ccontrol::checkMaxUsers() {
    if (maxUsers < curUsers) {
        ...
        stringstream DelQuery;
        DelQuery << UPMain << maxUsers << ", Value2 = " << dateMax << " WHERE VarName = 'MaxUsers'"
                 << ends;
#ifdef LOG_SQL
        elog << "ccontrol::checkMaxUsers> " << DelQuery.str().c_str() << endl;
#endif
        if (!SQLDb->Exec(DelQuery))
        //	if( PGRES_COMMAND_OK != status )
        {
            elog << "ccontrol::checkMaxUsers> SQL Failure: " << SQLDb->ErrorMessage() << endl;
        }
    }
}
...
bool ccontrol::addVersion(const string& newVer) {
    ...
    VerQuery << verChar << newVer << "')" << ends;
#ifdef LOG_SQL
    elog << "ccontrol::addVersion> " << VerQuery.str().c_str() << endl;
#endif

    if (!SQLDb->Exec(VerQuery))
    // if( PGRES_COMMAND_OK != status )
    {
        elog << "ccontrol::addVersion> SQL Failure: " << SQLDb->ErrorMessage() << endl;
    }
...
bool ccontrol::remVersion(const string& oldVer) {
    ...
    for (; ptr != VersionsList.end();) {
        if (!strcasecmp(oldVer, *ptr)) { // Found the version in the list
...
bool ccontrol::isValidVersion(const string& checkVer) {
    ...
    for (; ptr != VersionsList.end(); ++ptr) {
        if (!strcasecmp(checkVer, *ptr)) { // Found the version in the list
            return true;
        }
    }
    return false;
...
bool ccontrol::updateCheckVer(const bool newVal) {
    checkVer = newVal;
    stringstream ups;
    ups << "UPDATE misc SET Value1 = " << (newVal ? 1 : 0) << " WHERE VarName = 'CheckVer'" << ends;

    if (!SQLDb->Exec(ups))
    // if( PGRES_COMMAND_OK != status )
    {
        elog << "ccontrol::updateCheckVer> SQL Failure: " << SQLDb->ErrorMessage() << endl;
        return false;
    }
    return true;
}
...
bool ccontrol::glineChannelUsers(iClient* theClient, Channel* theChan, const string& reason,
                                 unsigned int gLength, const string& addedBy,
                                 bool excludeChanWithOper, bool unidented) {
    ccGline* TmpGline;
    iClient* TmpClient;
    string curIP;
    ...
    for (Channel::const_userIterator ptr = theChan->userList_begin();
        ...
        if (isIpOfOper(curIP)) {
            Notice(theClient,
                   "%s opered globally before and uses the same IP this user uses: %s!%s@%s",
                   getLastNUHOfOperFromIP(curIP).c_str(), TmpClient->getNickName().c_str(),
                   TmpClient->getUserName().c_str(), curIP.c_str());
            foundException = true;
        }
        ...
        if ((!TmpClient->getMode(iClient::MODE_SERVICES)) && !(IsAuth(TmpClient)) &&
            !(TmpClient->isOper())) {
    ...
    if (foundException) {
        if (isGlinedException(theChan->getName()) > 0) {
            ...
            if (!(excludeChanWithOper && foundOper))
                Notice(theClient, "There is an exception for at least one host on the channel. "
                                  "Channel G-line sent (forced)");
        } else if (!(excludeChanWithOper && foundOper)) {
            Notice(theClient, "There is an exception for at least one host on the channel. Send "
                              "the channel gline again to force.");
    ...
    for (; glinesIt != neededGlines.end(); ++glinesIt) {
        TmpGline = *glinesIt;
        ((excludeChanWithOper && foundOper) || (foundException && !exceptionForce))
            ? delete TmpGline
            : queueGline(TmpGline);
    }
    if (showCGIpsInLogs && (!excludeChanWithOper || !foundOper) &&
        (!foundException || exceptionForce)) {
    ...
    void ccontrol::isNowAnOper(iClient * theUser) {
        ...
        elog << "ccontrol::isNowAnOper()>  " << theUser->getRealNickUserHost() << "  ("
             << tServer->getName() << ")  " << ::time(0) << endl;
    ...
    // That function won't be needed afterall.
    {
        ...
        MsgChanLog("Refreshed opers IP list. %d global opers online right now. I have cumulated %d "
                   "different IPs since I started",
                   count, opersIPMap.size());
    }
    ...
    void ccontrol::announce(iClient * theClient, const string& text) {
        ...
        if (Network->findNick(AnnounceNick) != NULL) {
            if (tmpUser && !tmpUser->getLogs())
                Notice(theClient, "Nick %s is already in use for ANNOUNCE. Will use my own",
                       AnnounceNick.c_str());
        ...
        iClient* newClient = new iClient(MyUplink->getIntYY(), yyxxx, AnnounceNick, "announce",
                                         "AAAAAA", getHostName(), getHostName(), "+ok", string(), 0,
                                         0, string(), "Announcement Service.", ::time(0));
        assert(newClient != 0);
    ...
    bool ccontrol::reloadIpLisp(iClient * theClient, ccIpLisp * isp) {
        ...
        Notice(theClient, "Reloaded %d netblock%s for %s", count, (count == 1 ? "" : "s"),
               isp->getName().c_str());
        return ret;
    }
    ...
    ccIpLnb* ccontrol::getIpLnb(const string& Cidr, const string& Isp) {
        for (ipLnbIterator ptr = ipLnbVector.begin(); ptr != ipLnbVector.end(); ptr++)
            if ((Cidr == ptr->second->getCidr()) &&
                (!strcasecmp(ptr->second->ipLisp->getName().c_str(), Isp.c_str())))
                return ptr->second;
        return 0;
    }

    bool ccontrol::listIpLExceptionsOld(iClient * theClient, const string& ispName,
                                        bool listEmail) {

        if (ispName == "")
            Notice(theClient, "-= ISP list - listing a total of %d ISPs =-", ipLispVector.size());
        ...
        for (ipLispIterator ptr = ipLispVector.begin(); ptr != ipLispVector.end(); ptr++) {
            ...
            if (isp->isGroup()) {
                str1 += " [group]";
                s << isp->getName() << " (" << isp->getCount() << ") " << str1 << "  " << email
                  << "    Limit: " << isp->getLimit() << " total    Netblocks: ";
            } else
                s << isp->getName() << " (" << isp->getCount() << ") " << str1 << "  " << email
                  << "    Limit: " << isp->getLimit() << " per /" << isp->getCloneCidr()
                  << "    Netblocks: ";
    ...
    bool ccontrol::listIpLExceptions(iClient * theClient) {
        ...
        Notice(theClient, "%-31s  %-5s  %-13s  %-9s  %-20s  %-10s", "IP", "Count", "Limit",
               "ISP count", "ISP", "Tags");
        ...
        for (ipLispIterator ptr = ipLispVector.begin(); ptr != ipLispVector.end(); ptr++) {
            ...
            for (ipLnbIterator nptr = ipLnbVector.begin(); nptr != ipLnbVector.end(); nptr++) {
                if (isp != nptr->second->ipLisp)
                    continue;
                ccIpLnb* nb = nptr->second;
                Notice(theClient, "%-31s  %-5d  %4d %-8s  %-9d  %-20s %-s", nb->getCidr().c_str(),
                       nb->getCount(), isp->getLimit(), limit.c_str(), isp->getCount(),
                       isp->getName().c_str(), str1.c_str());
            }
            // if (ispName != "")
            // 	break;
        }
    ...
    bool ccontrol::insertIpLisp(iClient * theClient, const string& Name, int Connections,
                                int CloneCidr, const string& Email, int Active, int Forcecount) {
        ...
        if (getIpLisp(Name) != 0) {
            Notice(theClient, "There is already an ISP called %s", Name.c_str());
            return false;
        }
        ...
        // ipLispVector.push_back(ipLispVectorType::value_type(tempIpLisp,
        // tempIpLisp->getCloneCidr()));
    ...
    bool ccontrol::ipLuserInfo(iClient * theClient, iClient * target) {
        ...
        if (!irc_in_addr_valid(&target->getIP())) { // avoid 0:: (0.0.0.0) ip addresses
            Notice(theClient, "Come on. Are you really worried about %s's clone count?",
        ...
        */
        ...
        Notice(theClient, "--- Listing limits infos for %s [%s] ---",
               target->getNickUserHost().c_str(), ip.c_str());
        for (ipLnbListType::iterator nptr = ipLnbList.begin(); nptr != ipLnbList.end(); nptr++) {
            ...
            string userip =
                target->getUserName() + "@" + (nb->ipLisp->isGroup() ? nb->ipLisp->getName() : m);
            int identCount = 0;
            int identLimit = 0;
            ...
            if (itr != nb->ipLisp->ipLidentclonesMap.end()) {
                ...
                elog << "ccontrol::ipLuserInfo> bug: Did we really get here? Line #" << __LINE__
                     << endl;
            }
            itr = nb->ipLclonesMap.find(m);
            if (itr != nb->ipLclonesMap.end()) {
                Notice(theClient,
                       "%s: %d/%d connections for %s (ref: %s) - %d/%d connections for %s",
    ...
    bool ccontrol::ipLipInfo(iClient * theClient, const string& the_ip) {
        ...
        for (ipLnbIterator nptr = ipLnbVector.begin(); nptr != ipLnbVector.end(); nptr++) {
            ...
            if (nb->ipLisp->isv6() != isv6)
                continue;
            if (match(nb->getCidr(), ip) == 0) {
                /* Only keep going if the cidr < the previous one matched, except for forcecount
                 * netblocks, which show first in the list Note: ptr is of type ipLnbVectorType
                 * (pair<int, ccIpLnb*>) that is always sorted with netblocks that have forcecount
                 * at the top with nptr->first = 129, and all the others have nptr->first ==
                 * ntpr->second->getCidr2()
                 */
                if ((nptr->first < 129) &&
                    (nb->getCidr2() < smallestCidr)) { /* cidr/129 means we have forcecount set */
                    break;
                }
        ...
        for (ipLnbIterator nptr = tmpVector.begin(); nptr != tmpVector.end(); nptr++) {
            ...
            if ((nptr->first == 129) &&
                (std::find(nonForcecountCidrList.begin(), nonForcecountCidrList.end(),
                           nb->getCloneCidr()) != nonForcecountCidrList.end())) {
        ...
        */
        ...
        for (ipLnbListType::iterator nptr = ipLnbList.begin(); nptr != ipLnbList.end(); nptr++) {
            ...
            if (itr != nb->ipLclonesMap.end()) {
                ...
                elog << "ccontrol::ipLDropClient> bug: Did we really get here? Line #" << __LINE__
                     << endl;
                nb->incCount(-1);
                nb->ipLisp->incCount(-1);
            }

            string userip = theClient->getUserName() + "@" +
                            (nb->ipLisp->isGroup() ? nb->ipLisp->getName() : m);
            if (this->getIntYY() ==
                theClient->getIntYY()) /* This is a not-yet fully connected iauth client. */
                ...
                if (itr != nb->ipLisp->ipLidentclonesMap.end()) {
                    ...
                    elog << "ccontrol::ipLDropClient> bug: Did we really get here? Line #"
                         << __LINE__ << endl;
                }
            }
        }
    ...
    /*
     * returns false if no more clients are allowed. Only counting the new client if incCount is
     * true
     */
    bool ccontrol::isIpLClientAllowed(iClient * theClient, ipLretStructListType & retList,
                                      bool incCount) {
        ccIpLnb* nb;
        int numLeft = 1000000;
        int clonecidr;
        ...
        */
        ...
        for (ipLnbIterator nptr = tmpVector.begin(); nptr != tmpVector.end(); nptr++) {
            ...
            if (itr != nb->ipLclonesMap.end()) {
                ...
                // elog << "LIMITS DEBUG: ipLclonesMap insert for " << nb->getCidr() << " (/" <<
                // nb->getCloneCidr() << "): "
                //	<< m << endl;
            }
            if (incCount) {
            ...
            if (theClient->getIntYY() == getUplink()->getIntYY()) {
                /* It's a virtually not-yet-connected client from iauth, don't count user ident
                 * clones */
    ...
    bool ccontrol::insertIpLnb(iClient * theClient, const string& Cidr, int Isp, bool silent) {
        ...
        */
        ...
        if (ipLIsp == 0) {
            Notice(theClient,
                   "ccontrol::insertIpLnb> ipLIsp pointer to 0. That would be a bug. Poke a coder");
        ...
        if ((ipLIsp->isv6() == 0) && (isv6)) {
            Notice(theClient,
                   "%s is an ipv4 ISP. You need to delete the ISP entirely (not only its "
                   "netblocks) if you want to add ipv4 netblocks",
                   ipLIsp->getName().c_str());
            return false;
        }
        if ((ipLIsp->isv6() == 1) && (!isv6)) {
            Notice(theClient,
                   "%s is an ipv6 ISP. You need to delete the ISP entirely (not only its "
                   "netblocks) if you want to add ipv6 netblocks",
                   ipLIsp->getName().c_str());
            return false;
        }
        if ((clonecidr > 32) && (!isv6)) {
            Notice(theClient, "Cannot add an ipv4 netblock to an ISP that checks clones per /%d",
                   clonecidr);
            return false;
        }
        ...
        if ((atoi(st[1]) > clonecidr) && (!ipLIsp->isGroup())) {
            Notice(theClient,
                   "%s's clone limit is per /%d. You can't add a netblock smaller than that",
                   ipLIsp->getName().c_str(), clonecidr);
            return false;
        }
        ...
        if (!getValidCidr(Cidr, tCidr)) {
            Notice(theClient, "Unwanted cidr format: %s  -  Suggestion: %s", Cidr.c_str(),
                   tCidr.c_str());
            return false;
        }
        ...
        for (ipLispIterator iptr = ipLispVector.begin(); iptr != ipLispVector.end(); iptr++) {
            ...
            for (ipLnbIterator nptr = ipLnbVector.begin(); nptr != ipLnbVector.end(); nptr++) {
                ...
                if (tnb->getCidr() == Cidr) {
                    if (tisp == ipLIsp) {
                        Notice(theClient, "Netblock %s is already added for ISP %s", Cidr.c_str(),
                               tisp->getName().c_str());
                        return false;
                    }
                    if (clonecidr == tclonecidr) {
                        Notice(theClient,
                               "ISP %s already has clone matching for /%d on netblock %s",
                               tisp->getName().c_str(), tclonecidr, Cidr.c_str());
                        return false;
                    }
                }
                if (tisp == ipLIsp) {
                    if (cidrmatch(Cidr, tnb->getCidr()) == 0) {
                        Notice(theClient,
                               "Can't add netblock %s: it's overlapping with %s for the same ISP",
                               Cidr.c_str(), tnb->getCidr().c_str());
                        return false;
                    }
                }
            }
        ...
        for (xNetwork::const_clientIterator cItr = Network->clients_begin();
            ...
            */
            ...
            if (match(tempIpLnb->getCidr(), tIP) == 0) {
                ...
                /*
                 * The following code design is broken, because it currently does not give the
                 * ability to assign the connection to a new isp. Using the 3-line "drop client and
        ...
        if (!silent) {
            if (tempIpLnb->isForcecount())
                Notice(theClient,
                       "There are currently %c%d users%c online that match %s. %d users were "
                       "reassigned from other netblocks",
                       2, tempIpLnb->getCount(), 2, Cidr.c_str(), reassignedcount);
            else
                Notice(theClient,
                       "There are currently %c%d users%c online that have %s as the narrowest "
                       "match. %d users were reassigned from other netblocks",
                       2, tempIpLnb->getCount(), 2, Cidr.c_str(), reassignedcount);
        }
        return true;
    }

    bool ccontrol::delIpLnb(iClient * theClient, const string& IspName, const string& Host,
                            bool silent) {
        ccIpLnb* IpLnb;
        ccIpLisp* IpLisp;
        string tIspName;
        ...
        if (IpLnb == 0) {
            Notice(theClient, "Can't find ipL netblock for host %s associated to isp %s",
                   Host.c_str(), IspName.c_str());
            return false;
        }
        ...
        for (ipLRecentIauthListType::iterator cItr = ipLRecentIauthList.begin();
             cItr != ipLRecentIauthList.end(); ++cItr) {
        ...
        while (Itr != ipLnbVector.end()) {
            if ((Itr->second->getCidr() == IpLnb->getCidr()) &&
                (IpLnb->ipLisp->getName() == Itr->second->ipLisp->getName())) {
        ...
        if (!silent)
            Notice(theClient, "There were %c%d users%c online associated with %s's %s", 2,
                   cList.size(), 2, tIspName.c_str(), IpLnb->getCidr().c_str());
        delete IpLnb;
        for (list<iClient*>::iterator lItr = cList.begin(); lItr != cList.end(); lItr++) {
            ipLretStructListType retList;
    ...
    bool ccontrol::ipLcidrChangeCheck(iClient * theClient, ccIpLisp * isp, int newcidr) {
        ...
        if ((isp->isv6() == 0) && (newcidr > 32)) {
            Notice(theClient,
                   "Invalid cidr for an ipv6 isp. It must be between 8-32. You'll have to delete "
                   "the ISP and readd it if you want to remove the ipv6 tag for this isp");
            return false;
        }
        for (ipLnbIterator nptr = ipLnbVector.begin(); nptr != ipLnbVector.end(); nptr++) {
            ccIpLnb* nb = nptr->second;
        ...
        if (highCidr > newcidr) {
            Notice(theClient,
                   "You have at least one netblock that matches connections for a /%d, you cannot "
                   "set your limit per /%d"
                   ". new CloneCidr must be >%d if you're not deleting netblocks",
                   highCidr, newcidr, (highCidr - 1));
            return false;
        }
        return true;
    }
    ...
    bool ccontrol::delIpLisp(iClient * theClient, const string& Name) {
        ...
        while (ptr != ipLnbVector.end()) {
            ...
            if (ptr->second->ipLisp->getName() == IpLisp->getName()) {
                ptr2 = ptr;
                ptr2++;
                if (!delIpLnb(theClient, ptr->second->ipLisp->getName(), ptr->second->getCidr(),
                              false)) {
                    Notice(theClient, "Error while deleting netblock '%s'",
                           ptr->second->getCidr().c_str());
                }
                ptr = ptr2;
            } else
                ptr++;
    ...
    bool ccontrol::loadExceptions() {
        static const char Query[] =
            "SELECT "
            "name,id,AddedBy,AddedOn,lastmodby,lastmodon,maxlimit,active,email,clonecidr,"
            "forcecount,glunidented,isgroup,maxidentlimit,nogline FROM ipLISPs ORDER BY id";
...
#ifdef LOG_SQL
        elog << "ccontrol::loadExceptions> " << theQuery.str().c_str() << endl;
#endif

        if (!SQLDb->Exec(theQuery, true))
        // if( PGRES_TUPLES_OK != status )
        {
            elog << "ccontrol::loadExceptions> SQL Failure: " << SQLDb->ErrorMessage() << endl;
        ...
        for (unsigned int i = 0; i < SQLDb->Tuples(); i++) {
            ...
            tempIpLisp->setAddedOn(static_cast<time_t>(atoi(SQLDb->GetValue(i, 3).c_str())));
            tempIpLisp->setModBy(SQLDb->GetValue(i, 4));
            tempIpLisp->setModOn(static_cast<time_t>(atoi(SQLDb->GetValue(i, 5).c_str())));
        ...
        for (unsigned int i = 0; i < SQLDb->Tuples(); i++) {
            ...
            tempIpLnb->setAddedOn(static_cast<time_t>(atoi(SQLDb->GetValue(i, 3).c_str())));
            ...
            if (getIpLispbyID(ispID) == 0) { // This should not happen
                MsgChanLog("Loading LIMITS netblock failed for %s. IspID %d not found.",
                           tempIpLnb->getCidr().c_str(), ispID);
                delete tempIpLnb;
                continue;
            }
            // ipLnbVector.push_back(tempIpLnb);
    ...
    size_t ccontrol::iauthXQCheck(iServer * theServer, const string& Routing,
        ...
        iClient* newClient = new (std::nothrow) iClient(
            ...
            yyxxx, st[1], st[2], base64IP, st[4], st[4], "+", string(), 0, 0, string(), fullname,
            ::time(0));
        assert(newClient != 0);
        ...
        if (ipLRetVal) {
            ...
            for (ipLretStructListType::const_iterator Itr = retList.begin(); Itr != retList.end();
                ...
                ipLretStruct r = *Itr;
                ccIpLnb* nb = r.nb;
                MsgChanLimits("R(%c): %s - %s (%d/%d) - ref: %s's %s", r.type, IP.c_str(),
                              r.mask.c_str(), r.count, r.limit, nb->getIpLisp()->getName().c_str(),
                              nb->getCidr().c_str());
                // ss << "R(" << r.type << "): " << IP << " - " << r.mask << " (" << r.count << "/"
                // << r.limit << ")" << " - ref: " << nb->getIpLisp()->getName() << "'s " <<
                // nb->getCidr(); MsgChanLimits("%s", ss.str().c_str());
            }
